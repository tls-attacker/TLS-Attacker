        ...
        switch (group) {
            ...
            case SECP256K1:
                return new TwistedCurvePoint(new BigInteger(
                    ...
                    "8E8218F976D61730B6AB7C1926875C7CEA6B60A4FDAD0A10F021B52D99C51C2D", 16), new BigInteger("3319"),
                    NamedGroup.SECP256K1, new BigInteger(
            ...
            case BRAINPOOLP256R1:
                return new TwistedCurvePoint(new BigInteger(
                    ...
                    "A7222E3B35D69F71EE5E9F036E3339D3A4124D0CD0E4E63DD6B89969E6A3A4F9", 16), new BigInteger("175939"),
                    NamedGroup.BRAINPOOLP256R1, new BigInteger(
            ...
            case BRAINPOOLP384R1:
                return new TwistedCurvePoint(new BigInteger(
                    ...
                    16), new BigInteger("5557"), NamedGroup.BRAINPOOLP384R1, new BigInteger(
        ...
        switch (group) {
            ...
            case SECP192K1:
                return new TwistedCurvePoint(new BigInteger("BE403BE1E072BD43284DD8E6FA0ED4E71D1D7D66D8EEE872", 16),
                    ...
                    new BigInteger("619124299"), NamedGroup.SECP192K1, new BigInteger(
            ...
            case SECP256R1:
                return new TwistedCurvePoint(new BigInteger(
                    ...
                    "3317349640749355357762425066592395746459685764401801118712075735758936647"), NamedGroup.SECP256R1,
            ...
            case BRAINPOOLP256R1:
                return new TwistedCurvePoint(new BigInteger(
                    ...
                    "1CCD6EB649E0246A4B4E5A673DCC8729ED383FAC14C2E998D00191CF325D1935", 16),
                    new BigInteger("492167257"), NamedGroup.BRAINPOOLP256R1, new BigInteger(
