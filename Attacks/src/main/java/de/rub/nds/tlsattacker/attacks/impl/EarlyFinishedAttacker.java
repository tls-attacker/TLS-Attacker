...
public class EarlyFinishedAttacker extends Attacker<EarlyFinishedCommandConfig> {
    ...
    public EarlyFinishedVulnerabilityType performCheck() {
        ...
        workflowTrace
            .addTlsAction(MessageActionFactory.createTLSAction(tlsConfig, connection, ConnectionEndType.CLIENT, messages));
        messages = new LinkedList<>();
        messages.add(new ChangeCipherSpecMessage());
        messages.add(new FinishedMessage());
        workflowTrace
            .addTlsAction(MessageActionFactory.createTLSAction(tlsConfig, connection, ConnectionEndType.SERVER, messages));
