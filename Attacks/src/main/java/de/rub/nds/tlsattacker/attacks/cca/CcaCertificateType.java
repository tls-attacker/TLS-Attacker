...
public enum CcaCertificateType {
    ...
    ROOTv3_CAv3_LEAF_RSAv3_Md2withRSA(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The leaf certificate uses MD2withRSA which is a weak algorithm.", false, true),
    ROOTv3_CAv3_LEAF_RSAv3_Md4withRSA(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The leaf certificate uses MD4withRSA which is a weak algorithm.", false, true),
    ROOTv3_CAv3_LEAF_RSAv3_Md5withRSA(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The leaf certificate uses MD5withRSA which is a weak algorithm.", false, true),
    ROOTv3_CAv3_LEAF_RSAv3_weakKey(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The leaf certificate uses a 512 bit RSA key with e=3 which is weak.", false, true),
    ECROOTv3_CAv3_LEAF_ECv3(
        "EC Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "All use ECC.", false, true),
    ...
    DSAROOTv3_CAv3_LEAF_DHv3_KeyAgreement(
        "DH Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The chain uses DSA while only the leaf uses DH with keyUsage keyAgreement only.", false, true),
    DSAROOTv3_CAv3_LEAF_DHv3(
        "DH Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The chain uses DSA while only the leaf uses DH.", false, true),
    ECROOTv3_CAv3_LEAF_ECv3_KeyAgreement(
        "ECDH Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The chain uses ECDSA while only the leaf uses ECDH with keyUsage keyAgreement only.", false, true),
    ECROOTv3_CAv3_LEAF_ECv3_KeyAgreement2(
        "ECDH Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            ...
            + "different curve than the other testcase.", false, true),
    ROOTv3_CAv3_LEAF_DHv3_KeyAgreement(
        "DH Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The chain uses RSA while only the leaf uses DH with keyUsage keyAgreement only.", false, true),
    ROOTv3_CAv3_LEAF_DHv3(
        "DH Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The chain uses RSA while only the leaf uses DH.", false, true),
    ROOTv3_CAv3_LEAF_ECv3(
        "DH Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The chain uses RSA while only the leaf uses ECDH/DSA.", false, true),
    ROOTv3_CAv3_LEAF_ECv3_KeyAgreement(
        "DH Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The chain uses RSA while only the leaf uses ECDH with keyUsage keyAgreement only.", false, true),
    ...
    DSAROOTv3_CAv3_LEAF_DSAv3_Sha1(
        "DSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "All use DSA and the leaf is signed using Sha1WithDSA (weak algo).", false, true),
    ECROOTv3_CAv3_LEAF_ECv3_Sha1(
        "EC Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "All use ECDSA and the leaf is signed using Sha1WithECDSA (weak algo).", false, true),
    ECROOTv3_CAv3_LEAF_ECv3_GarbageParameters(
        "EC Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA. All use "
            ...
            + "null b.) parameters are invalid", false, true),
    DSAROOTv3_CAv3_LEAF_DSAv3_GarbageParameters(
        "DSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA. All"
            ...
            + " are not null b.) parameters are invalid", false, true),
    ECROOTv3_CAv3CustomCurve_LEAF_ECv3(
        "EC Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "All use ECC and the intermedia CA uses a custom curve (secp384r1 with custom generator).", false, true),
    ECROOTv3_Curveball_CAv3_LEAF_ECv3(
        "EC Leaf certificate generated based on the 'new' (root-)CA certificate with one intermediate CA."
            ...
            + "CVE-2020-0601 (Curveball/Chain of Fools).", false, true),
    ...
    ROOTv3_CAv3_LEAF_RSAv3_UnknownExt(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA. "
            + "The Leaf certificate contains and unknown extension.", false, true),
    ...
    ROOTv3_CAv3_KeyUsageDigitalSignatures_LEAF_RSAv3(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA. "
            + "The intermediate v3 CA certificate specifies a KeyUsage for digital signatures only.", false, true),
    ...
    ROOTv3_CAv3_LEAF_RSAv3__RDN_difference(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA. "
            ...
            + " could succeed in this case.", false, true),
    ROOTv3_CAv3_LEAF_RSAv3_extendedKeyUsageServerAuth(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA. "
            + "The leaf certificates extended key usage extensions specifies server authentication only.", false, true),
    ROOTv3_CAv3_LEAF_RSAv3_extendedKeyUsageCodeSign(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA. "
            + "The leaf certificates extended key usage extensions specifies code signing only.", false, true),
    ...
    ROOTv3_CAv3_LEAF_RSAv3_KeyUsageKeyAgreement(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The leaf certificates key usage extensions allows key Agreement only.", false, true),
    ROOTv3_CAv3_LEAF_RSAv3_SelfSigned(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA."
            + "The leaf certificate points to the intermediate CA but is actually self signed.", false, true),
    ...
    ROOTv3_CAv3_NameConstraints_LEAF_RSAv3_SAN2Crit(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA. "
            + "The intermediate v3 CA certificate imposes NameConstraints that aren't met by the leaf certificate "
            + "in the SAN, but are met in the Subject. The extension is marked as critical.", false, true),
    ROOTv3_CAv3_NameConstraints_LEAF_RSAv3_SAN(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA. "
            + "The intermediate v3 CA certificate imposes NameConstraints that aren't met by the leaf certificate "
            + "in the subject, but are met in the SAN. The extension is marked as non critical.", false, true),
    ROOTv3_CAv3_NameConstraints_LEAF_RSAv3_SAN2(
        "RSA Leaf certificate generated based on the provided (root-)CA certificate with one intermediate CA. "
            + "The intermediate v3 CA certificate imposes NameConstraints that aren't met by the leaf certificate "
            + "in the SAN, but are met in the Subject. The extension is marked as non critical.", false, true),
