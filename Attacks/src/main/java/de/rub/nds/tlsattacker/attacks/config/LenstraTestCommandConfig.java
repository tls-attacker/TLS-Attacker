 ...
 */
public class LenstraTestCommandConfig extends ClientCommandConfig {

    public static final String ATTACK_COMMAND = "lenstra_test";

    public LenstraTestCommandConfig() {
