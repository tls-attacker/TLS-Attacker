...
public abstract class WorkflowExecutor {
    ...
    public WorkflowExecutor(TransportHandler transportHandler, TlsContext tlsContext) {
	...
	if (this.tlsContext == null || this.transportHandler == null || this.recordHandler == null) {
