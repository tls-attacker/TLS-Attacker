...
public final class TlsContextAnalyzer {
	...
	List<ProtocolMessage> configuredProtocolMessageOrder = tlsContext.getWorkflowTrace()
		.getConfiguredReceivingMessages();
	List<ProtocolMessage> protocolMessages = tlsContext.getWorkflowTrace().getActuallyReceivedMessages();
	...
	List<ProtocolMessage> protocolMessages = tlsContext.getWorkflowTrace().getConfiguredReceivingMessages();
	List<ProtocolMessage> actuallyReveivedMessages = tlsContext.getWorkflowTrace().getActuallyReceivedMessages();
