...
public class MaxFragmentLengthExtensionHandlerTest {
    ...
    public void testParseExtension() {
        ...
        MaxFragmentLengthExtensionMessage parsedMessage = (MaxFragmentLengthExtensionMessage) extensionHandler.getExtensionMessage();

        Assert.assertEquals("Tests the returned pointer of the parseExtension method",
                (int) 5, returnedPointer);
        ...
        Assert.assertEquals("Tests the extensionLength of the parseExtension method",
                new Integer(1), parsedMessage.getExtensionLength().getValue());
    ...
    /**
     * Tests the initializeClientHelloExtension method of the MaxFragmentLengthExtensionHandler
     */
    @Test
    public void testInitializeClientHelloExtension() {
        ...
        Assert.assertArrayEquals("Tests if the extension bytes are set correctly by the initializeClientHelloExtension method",
                extensionMessage, initializedMessage.getExtensionBytes().getValue());
        Assert.assertEquals("Tests if the extension length is set correctly by the initializeClientHelloExtension method",
                new Integer(1), initializedMessage.getExtensionLength().getValue());
        Assert.assertArrayEquals("Tests if the extension type method is set correctly by the initializeClientHelloExtension method",
                ExtensionType.MAX_FRAGMENT_LENGTH.getValue(), initializedMessage.getExtensionType().getValue());
        Assert.assertArrayEquals("Tests if the max fragment length is set correctly by the initializeClientHelloExtension method",
