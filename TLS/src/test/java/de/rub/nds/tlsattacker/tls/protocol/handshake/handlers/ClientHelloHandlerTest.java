...
public class ClientHelloHandlerTest {
	...
	de.rub.nds.tlsattacker.tls.protocol.handshake.messages.ClientHelloMessage message = (de.rub.nds.tlsattacker.tls.protocol.handshake.messages.ClientHelloMessage) handler
		.getProtocolMessage();
