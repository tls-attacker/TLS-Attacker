...
import Graphs.GlobalBranchTree;
...
public class GlobalBranchTreeTest {
    ...
    /**
     * @Ignore @Test public void testConnectedTree() {
     *         DirectedGraph<BranchVertex, CountEdge> g =
     *         GlobalBranchTree.buildGraph(new
     *         File("/home/ic0ns/Traces/TestCases/openssl.tree"));
     *         ConnectivityInspector inspector = new ConnectivityInspector(g);
     *         assertTrue
     *         ("Failure: The GlobalBranchTree should be a connected Graph."
     *         ,inspector.isGraphConnected()); }
     */

    /**
     * @Test public void TestValidTree() { DirectedGraph<BranchVertex,
     *       CountEdge> g = GlobalBranchTree.buildGraph(new
     *       File("/home/ic0ns/Traces/TestCases/openssl.tree"));
     * 
     *       }
     */
	...
	try {
	    ...
	    assertNull(
		    "Failure: Should not return a Vertex that if the searched Vertex is not in the Graph, should return null instead",
		    v);
