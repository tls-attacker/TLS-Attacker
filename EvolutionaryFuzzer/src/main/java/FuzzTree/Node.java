 ...
 * @param <T> Type of Data organized by the Node
 */
public class Node<T>
{
    ...
    /**
     *
     * @param data Data which the Node helds
     */
    public Node(T data)
    {
        this.data = data;
     ...
     *
     * @throws NullPointerException if null is added as a Child
     * @param child Node which is added as a Child
     */
