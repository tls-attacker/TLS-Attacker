...
public class AgentFactory {
     ...
     * @throws tlsattacker.fuzzer.exceptions.IllegalAgentException When an
     * illegal Agent is selected
     *
     */
