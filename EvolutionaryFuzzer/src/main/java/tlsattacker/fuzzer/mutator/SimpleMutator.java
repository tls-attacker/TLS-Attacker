...
public class SimpleMutator extends Mutator {
    ...
    /**
     * Chooses a random TestVecotr and applies different Modification to it as specified in the configuration file.
     * There is a change the a single TestVector is modified multiple times in a row.
