 ...
 */
public class ContainsInternalErrorRule extends Rule {

    private EvolutionaryFuzzerConfig evoConfig;
    private int found = 0;

    public ContainsInternalErrorRule(EvolutionaryFuzzerConfig evoConfig) {
    ...
    private static final Logger LOG = Logger.getLogger(ContainsInternalErrorRule.class.getName());
