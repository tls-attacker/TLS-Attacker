...
//
//    @Parameter(names = "-crypto", description = "Checks supported cipher suites and other crypto properties.")
//    protected boolean crypto;
//
//    @Parameter(names = "-protocols", description = "Checks supported TLS protocol versions.")
//    protected boolean supportedProtocols;
//
//    @Parameter(names = "-cipher_suite_order", description = "Checks whether the server supports cipher suite ordering.")
//    protected boolean cipherSuiteOrder;
//
//    @Parameter(names = "-named_curves", description = "Checks supported elliptic curves.")
//    protected boolean supportedNamedCurves;
//    
//    @Parameter(names = "-signature_hash_algorithms", description = "Checks supported signature and hash algorithms.")
//    protected boolean supportedSignatureAndHashAlgorithms;
//
//    @Parameter(names = "-attacks", description = "Checks for potential vulnerabilities.")
