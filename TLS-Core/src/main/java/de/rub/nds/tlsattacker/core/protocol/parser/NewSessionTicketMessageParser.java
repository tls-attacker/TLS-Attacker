...
public class NewSessionTicketMessageParser extends HandshakeMessageParser<NewSessionTicketMessage> {

    public NewSessionTicketMessageParser(int pointer, byte[] array, ProtocolVersion version) {
