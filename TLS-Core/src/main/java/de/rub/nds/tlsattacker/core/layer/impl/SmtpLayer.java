        ...
        try {
            do {
                if(context.getContext().getConnection().getLocalConnectionEndType() == ConnectionEndType.CLIENT) {
                    ...
                    if(smtpReply != null) {
                        LOGGER.trace("Expecting reply of type: {}", smtpReply.getClass().getSimpleName());
                    } else {
                        smtpReply = new SmtpUnknownReply();
                        LOGGER.trace("Expected reply type unclear, receiving {} instead", smtpReply.getClass().getSimpleName());
                    }
