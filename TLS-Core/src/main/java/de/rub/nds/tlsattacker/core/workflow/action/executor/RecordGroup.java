...
public class RecordGroup {
	...
	/**
	 * Splits a list of received records into RecordGroups such that records 
	 * in each record group share the following characteristics:
	 * 1. they are of the same type (Blob or real records);
	 * 2. they use the same cipher state (for DTLS, this means they have the same epochs); 
	 * 3. their content is of the same type.
	 * 
	 * 
	 * This allows for records in a particular RecordGroup to be processed together.
	 */
