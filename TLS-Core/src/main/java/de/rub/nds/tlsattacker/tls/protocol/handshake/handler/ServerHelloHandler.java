...
//        ServerHelloMessage message = new ServerHelloMessage(tlsContext.getConfig());
//        ServerHelloMessagePreparator preparator = new ServerHelloMessagePreparator(tlsContext, message);
//        preparator.prepare();
//        adjustTLSContext(message);
//        ServerHelloMessageSerializer serializer = new ServerHelloMessageSerializer(message);
...
//        return protocolMessage.getCompleteResultingMessage().getValue();
    ...
    protected void adjustTLSContext(ServerHelloMessage message) {
        ...
        tlsContext.setCompressionMethod(CompressionMethod.getCompressionMethod(message.getSelectedCompressionMethod().getValue()));
        tlsContext.setSessionID(message.getSessionId().getValue());
        tlsContext.setSelectedProtocolVersion(ProtocolVersion.getProtocolVersion(message.getProtocolVersion().getValue()));
