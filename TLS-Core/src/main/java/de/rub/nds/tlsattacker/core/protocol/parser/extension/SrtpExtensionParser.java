...
public class SrtpExtensionParser extends ExtensionParser<SrtpExtensionMessage> {
    ...
    public void parseExtensionMessageContent(SrtpExtensionMessage msg) {
        ...
        LOGGER.debug("The srtp extension parser parsed the srtp protection profiles length of " + msg.getSrtpProtectionProfilesLength().getValue());
        msg.setSrtpProtectionProfiles(parseByteArrayField(msg.getSrtpProtectionProfilesLength().getValue()));
        LOGGER.debug("The srtp extension parser parsed the srtp protection profiles " + ArrayConverter.bytesToHexString(msg.getSrtpProtectionProfiles()));
        ...
        LOGGER.debug("The srtp extension parser parsed the srtp mki " + ArrayConverter.bytesToHexString(msg.getSrtpMki()));
        }
        else {
