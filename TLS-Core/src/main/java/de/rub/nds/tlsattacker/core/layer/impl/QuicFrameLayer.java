...
public class QuicFrameLayer
     ...
     */
    @Override
    public LayerProcessingResult<QuicFrame> sendConfigurationInternal() throws IOException {
     ...
     */
    @Override
    public LayerProcessingResult<QuicFrame> sendDataInternal(LayerProcessingHint hint, byte[] data)
            throws IOException {
     ...
     */
    @Override
    public LayerProcessingResult<QuicFrame> receiveDataInternal() {
        try {
