...
/**
 * This action toggles the active state of one or multiple toggleable layers. It is designed to be
 * used in conjunction with {@link ToggleableLayerWrapper} and will not execute as planned for layer
 * stacks that do not contain the requested ToggleableLayerWrappers.
 *
...
public class ToggleLayerAction extends ConnectionBoundAction {
    ...
    public void execute(State state) throws ActionExecutionException {
        ...
        for (LayerType layerType : targetedLayers) {
            ...
            if (layer instanceof ToggleableLayerWrapper) {
                ...
                // this triggers when a requested layer is not a ToggleableLayerWrapper OR the layer
                // is null (does not even exist)
    ...
    /**
     * This method is used to update the ToggleableLayerWrapper for different incarnations of
     * ToggleLayerAction to implement.
     */
     ...
     * stack. If not, the action was not executed as planned. It is important to note that this
     * method does not check whether the active layers were actually changed, only whether they were
