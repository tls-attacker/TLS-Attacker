...
public enum CipherSuite {
    ...
    TLS_KRB5_WITH_3DES_EDE_CBC_SHA(0x1F), TLS_KRB5_WITH_RC4_128_SHA(0x20), TLS_KRB5_WITH_IDEA_CBC_SHA(0x21),
    TLS_KRB5_WITH_DES_CBC_MD5(0x22), TLS_KRB5_WITH_3DES_EDE_CBC_MD5(0x23), TLS_KRB5_WITH_RC4_128_MD5(0x24),
    TLS_KRB5_WITH_IDEA_CBC_MD5(0x25), TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA(0x26), TLS_KRB5_EXPORT_WITH_RC2_CBC_40_SHA(
        0x27), TLS_KRB5_EXPORT_WITH_RC4_40_SHA(0x28), TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5(0x29),
    TLS_KRB5_EXPORT_WITH_RC2_CBC_40_MD5(0x2A), TLS_KRB5_EXPORT_WITH_RC4_40_MD5(0x2B), TLS_PSK_WITH_NULL_SHA(0x2C),
    TLS_DHE_PSK_WITH_NULL_SHA(0x2D), TLS_RSA_PSK_WITH_NULL_SHA(0x2E), TLS_RSA_WITH_AES_128_CBC_SHA(0x2F),
    TLS_DH_DSS_WITH_AES_128_CBC_SHA(0x30), TLS_DH_RSA_WITH_AES_128_CBC_SHA(0x31),
    TLS_DHE_DSS_WITH_AES_128_CBC_SHA(0x32), TLS_DHE_RSA_WITH_AES_128_CBC_SHA(0x33), TLS_DH_anon_WITH_AES_128_CBC_SHA(
        0x34), TLS_RSA_WITH_AES_256_CBC_SHA(0x35), TLS_DH_DSS_WITH_AES_256_CBC_SHA(0x36),
    TLS_DH_RSA_WITH_AES_256_CBC_SHA(0x37), TLS_DHE_DSS_WITH_AES_256_CBC_SHA(0x38), TLS_DHE_RSA_WITH_AES_256_CBC_SHA(
        0x39), TLS_DH_anon_WITH_AES_256_CBC_SHA(0x3A), TLS_RSA_WITH_NULL_SHA256(0x3B), TLS_RSA_WITH_AES_128_CBC_SHA256(
        0x3C), TLS_RSA_WITH_AES_256_CBC_SHA256(0x3D), TLS_DH_DSS_WITH_AES_128_CBC_SHA256(0x3E),
    TLS_DH_RSA_WITH_AES_128_CBC_SHA256(0x3F), TLS_DHE_DSS_WITH_AES_128_CBC_SHA256(0x40),
    TLS_RSA_WITH_CAMELLIA_128_CBC_SHA(0x41), TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA(0x42),
    TLS_DH_RSA_WITH_CAMELLIA_128_CBC_SHA(0x43), TLS_DHE_DSS_WITH_CAMELLIA_128_CBC_SHA(0x44),
    TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA(0x45), TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA(0x46),
    UNOFFICIAL_TLS_ECDH_ECDSA_WITH_NULL_SHA(0x47), UNOFFICIAL_TLS_ECDH_ECDSA_WITH_RC4_128_SHA(0x48),
    UNOFFICIAL_TLS_ECDH_ECDSA_WITH_DES_CBC_SHA(0X49), UNOFFICIAL_TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA(0X4A),
    UNOFFICIAL_TLS_ECDH_ECNRA_WITH_NULL_SHA(0x4B), UNOFFICIAL_TLS_ECDH_ECNRA_WITH_RC4_128_SHA(0x4C),
    UNOFFICIAL_TLS_ECDH_ECNRA_WITH_DES_CBC_SHA(0x4D), UNOFFICIAL_TLS_ECDH_ECNRA_WITH_3DES_EDE_CBC_SHA(0x4E),
    UNOFFICIAL_TLS_ECMQV_ECDSA_WITH_NULL_SHA(0x4F), UNOFFICIAL_TLS_ECMQV_ECDSA_WITH_RC4_128_SHA(0x50),
    UNOFFICIAL_TLS_ECMQV_ECDSA_WITH_DES_CBC_SHA(0x51), UNOFFICIAL_TLS_ECMQV_ECDSA_WITH_3DES_EDE_CBC_SHA(0x52),
    UNOFFICIAL_TLS_ECMQV_ECNRA_WITH_NULL_SHA(0x53), UNOFFICIAL_TLS_ECMQV_ECNRA_WITH_RC4_128_SHA(0x54),
    UNOFFICIAL_TLS_ECMQV_ECNRA_WITH_DES_CBC_SHA(0x55), UNOFFICIAL_TLS_ECMQV_ECNRA_WITH_3DES_EDE_CBC_SHA(0x56),
    UNOFFICIAL_TLS_ECDH_anon_WITH_NULL_SHA(0x57), UNOFFICIAL_TLS_ECDH_anon_WITH_RC4_128_SHA(0x58),
    UNOFFICIAL_TLS_ECDH_anon_WITH_DES_CBC_SHA(0x59), UNOFFICIAL_TLS_ECDH_anon_WITH_3DES_EDE_CBC_SHA(0x5A),
    UNOFFICIAL_TLS_ECDH_anon_EXPORT_WITH_DES40_CBC_SHA(0x5B), UNOFFICIAL_TLS_ECDH_anon_EXPORT_WITH_RC4_40_SHA(0x5C),
    TLS_RSA_EXPORT1024_WITH_RC4_56_MD5(0x60), TLS_RSA_EXPORT1024_WITH_RC2_56_MD5(0x61),
    TLS_RSA_EXPORT1024_WITH_DES_CBC_SHA(0x62), TLS_DHE_DSS_EXPORT1024_WITH_DES_CBC_SHA(0x63),
    TLS_RSA_EXPORT1024_WITH_RC4_56_SHA(0x64), TLS_DHE_DSS_EXPORT1024_WITH_RC4_56_SHA(0x65),
    TLS_DHE_DSS_WITH_RC4_128_SHA(0x66), TLS_DHE_RSA_WITH_AES_128_CBC_SHA256(0x67), TLS_DH_DSS_WITH_AES_256_CBC_SHA256(
        0x68), TLS_DH_RSA_WITH_AES_256_CBC_SHA256(0x69), TLS_DHE_DSS_WITH_AES_256_CBC_SHA256(0x6A),
    TLS_DHE_RSA_WITH_AES_256_CBC_SHA256(0x6B), TLS_DH_anon_WITH_AES_128_CBC_SHA256(0x6C),
    TLS_DH_anon_WITH_AES_256_CBC_SHA256(0x6D), TLS_GOSTR341094_WITH_28147_CNT_IMIT(0x80),
    TLS_GOSTR341001_WITH_28147_CNT_IMIT(0x81), TLS_GOSTR341094_WITH_NULL_GOSTR3411(0x82),
    TLS_GOSTR341001_WITH_NULL_GOSTR3411(0x83), TLS_RSA_WITH_CAMELLIA_256_CBC_SHA(0x84),
    TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA(0x85), TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA(0x86),
    TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA(0x87), TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA(0x88),
    TLS_DH_anon_WITH_CAMELLIA_256_CBC_SHA(0x89), TLS_PSK_WITH_RC4_128_SHA(0x8A), TLS_PSK_WITH_3DES_EDE_CBC_SHA(0x8B),
    TLS_PSK_WITH_AES_128_CBC_SHA(0x8C), TLS_PSK_WITH_AES_256_CBC_SHA(0x8D), TLS_DHE_PSK_WITH_RC4_128_SHA(0x8E),
    TLS_DHE_PSK_WITH_3DES_EDE_CBC_SHA(0x8F), TLS_DHE_PSK_WITH_AES_128_CBC_SHA(0x90), TLS_DHE_PSK_WITH_AES_256_CBC_SHA(
        0x91), TLS_RSA_PSK_WITH_RC4_128_SHA(0x92), TLS_RSA_PSK_WITH_3DES_EDE_CBC_SHA(0x93),
    TLS_RSA_PSK_WITH_AES_128_CBC_SHA(0x94), TLS_RSA_PSK_WITH_AES_256_CBC_SHA(0x95), TLS_RSA_WITH_SEED_CBC_SHA(0x96),
    TLS_DH_DSS_WITH_SEED_CBC_SHA(0x97), TLS_DH_RSA_WITH_SEED_CBC_SHA(0x98), TLS_DHE_DSS_WITH_SEED_CBC_SHA(0x99),
    TLS_DHE_RSA_WITH_SEED_CBC_SHA(0x9A), TLS_DH_anon_WITH_SEED_CBC_SHA(0x9B), TLS_RSA_WITH_AES_128_GCM_SHA256(0x9C),
    TLS_RSA_WITH_AES_256_GCM_SHA384(0x9D), TLS_DHE_RSA_WITH_AES_128_GCM_SHA256(0x9E),
    TLS_DHE_RSA_WITH_AES_256_GCM_SHA384(0x9F), TLS_DH_RSA_WITH_AES_128_GCM_SHA256(0xA0),
    TLS_DH_RSA_WITH_AES_256_GCM_SHA384(0xA1), TLS_DHE_DSS_WITH_AES_128_GCM_SHA256(0xA2),
    TLS_DHE_DSS_WITH_AES_256_GCM_SHA384(0xA3), TLS_DH_DSS_WITH_AES_128_GCM_SHA256(0xA4),
    TLS_DH_DSS_WITH_AES_256_GCM_SHA384(0xA5), TLS_DH_anon_WITH_AES_128_GCM_SHA256(0xA6),
    TLS_DH_anon_WITH_AES_256_GCM_SHA384(0xA7), TLS_PSK_WITH_AES_128_GCM_SHA256(0xA8), TLS_PSK_WITH_AES_256_GCM_SHA384(
        0xA9), TLS_DHE_PSK_WITH_AES_128_GCM_SHA256(0xAA), TLS_DHE_PSK_WITH_AES_256_GCM_SHA384(0xAB),
    TLS_RSA_PSK_WITH_AES_128_GCM_SHA256(0xAC), TLS_RSA_PSK_WITH_AES_256_GCM_SHA384(0xAD),
    TLS_PSK_WITH_AES_128_CBC_SHA256(0xAE), TLS_PSK_WITH_AES_256_CBC_SHA384(0xAF), TLS_PSK_WITH_NULL_SHA256(0xB0),
    TLS_PSK_WITH_NULL_SHA384(0xB1), TLS_DHE_PSK_WITH_AES_128_CBC_SHA256(0xB2),
    TLS_DHE_PSK_WITH_AES_256_CBC_SHA384(0xB3), TLS_DHE_PSK_WITH_NULL_SHA256(0xB4), TLS_DHE_PSK_WITH_NULL_SHA384(0xB5),
    TLS_RSA_PSK_WITH_AES_128_CBC_SHA256(0xB6), TLS_RSA_PSK_WITH_AES_256_CBC_SHA384(0xB7), TLS_RSA_PSK_WITH_NULL_SHA256(
        0xB8), TLS_RSA_PSK_WITH_NULL_SHA384(0xB9), TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256(0xBA),
    TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA256(0xBB), TLS_DH_RSA_WITH_CAMELLIA_128_CBC_SHA256(0xBC),
    TLS_DHE_DSS_WITH_CAMELLIA_128_CBC_SHA256(0xBD), TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA256(0xBE),
    TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256(0xBF), TLS_RSA_WITH_CAMELLIA_256_CBC_SHA256(0xC0),
    TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256(0xC1), TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256(0xC2),
    TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA256(0xC3), TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA256(0xC4),
    TLS_DH_anon_WITH_CAMELLIA_256_CBC_SHA256(0xC5), TLS_EMPTY_RENEGOTIATION_INFO_SCSV(0xFF), TLS_AES_128_GCM_SHA256(
        0x1301), TLS_AES_256_GCM_SHA384(0x1302), TLS_CHACHA20_POLY1305_SHA256(0x1303), TLS_AES_128_CCM_SHA256(0x1304),
    TLS_AES_128_CCM_8_SHA256(0x1305), TLS_FALLBACK_SCSV(0x5600), TLS_ECDH_ECDSA_WITH_NULL_SHA(0xC001),
    TLS_ECDH_ECDSA_WITH_RC4_128_SHA(0xC002), TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA(0xC003),
    TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA(0xC004), TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA(0xC005),
    TLS_ECDHE_ECDSA_WITH_NULL_SHA(0xC006), TLS_ECDHE_ECDSA_WITH_RC4_128_SHA(0xC007),
    TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA(0xC008), TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA(0xC009),
    TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA(0xC00A), TLS_ECDH_RSA_WITH_NULL_SHA(0xC00B), TLS_ECDH_RSA_WITH_RC4_128_SHA(
        0xC00C), TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA(0xC00D), TLS_ECDH_RSA_WITH_AES_128_CBC_SHA(0xC00E),
    TLS_ECDH_RSA_WITH_AES_256_CBC_SHA(0xC00F), TLS_ECDHE_RSA_WITH_NULL_SHA(0xC010), TLS_ECDHE_RSA_WITH_RC4_128_SHA(
        0xC011), TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA(0xC012), TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA(0xC013),
    TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA(0xC014), TLS_ECDH_anon_WITH_NULL_SHA(0xC015), TLS_ECDH_anon_WITH_RC4_128_SHA(
        0xC016), TLS_ECDH_anon_WITH_3DES_EDE_CBC_SHA(0xC017), TLS_ECDH_anon_WITH_AES_128_CBC_SHA(0xC018),
    TLS_ECDH_anon_WITH_AES_256_CBC_SHA(0xC019), TLS_SRP_SHA_WITH_3DES_EDE_CBC_SHA(0xC01A),
    TLS_SRP_SHA_RSA_WITH_3DES_EDE_CBC_SHA(0xC01B), TLS_SRP_SHA_DSS_WITH_3DES_EDE_CBC_SHA(0xC01C),
    TLS_SRP_SHA_WITH_AES_128_CBC_SHA(0xC01D), TLS_SRP_SHA_RSA_WITH_AES_128_CBC_SHA(0xC01E),
    TLS_SRP_SHA_DSS_WITH_AES_128_CBC_SHA(0xC01F), TLS_SRP_SHA_WITH_AES_256_CBC_SHA(0xC020),
    TLS_SRP_SHA_RSA_WITH_AES_256_CBC_SHA(0xC021), TLS_SRP_SHA_DSS_WITH_AES_256_CBC_SHA(0xC022),
    TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256(0xC023), TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384(0xC024),
    TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256(0xC025), TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384(0xC026),
    TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256(0xC027), TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384(0xC028),
    TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256(0xC029), TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384(0xC02A),
    TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256(0xC02B), TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384(0xC02C),
    TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256(0xC02D), TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384(0xC02E),
    TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256(0xC02F), TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384(0xC030),
    TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256(0xC031), TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384(0xC032),
    TLS_ECDHE_PSK_WITH_RC4_128_SHA(0xC033), TLS_ECDHE_PSK_WITH_3DES_EDE_CBC_SHA(0xC034),
    TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA(0xC035), TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA(0xC036),
    TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA256(0xC037), TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA384(0xC038),
    TLS_ECDHE_PSK_WITH_NULL_SHA(0xC039), TLS_ECDHE_PSK_WITH_NULL_SHA256(0xC03A),
    TLS_ECDHE_PSK_WITH_NULL_SHA384(0xC03B), TLS_RSA_WITH_ARIA_128_CBC_SHA256(0xC03C), TLS_RSA_WITH_ARIA_256_CBC_SHA384(
        0xC03D), TLS_DH_DSS_WITH_ARIA_128_CBC_SHA256(0xC03E), TLS_DH_DSS_WITH_ARIA_256_CBC_SHA384(0xC03F),
    TLS_DH_RSA_WITH_ARIA_128_CBC_SHA256(0xC040), TLS_DH_RSA_WITH_ARIA_256_CBC_SHA384(0xC041),
    TLS_DHE_DSS_WITH_ARIA_128_CBC_SHA256(0xC042), TLS_DHE_DSS_WITH_ARIA_256_CBC_SHA384(0xC043),
    TLS_DHE_RSA_WITH_ARIA_128_CBC_SHA256(0xC044), TLS_DHE_RSA_WITH_ARIA_256_CBC_SHA384(0xC045),
    TLS_DH_anon_WITH_ARIA_128_CBC_SHA256(0xC046), TLS_DH_anon_WITH_ARIA_256_CBC_SHA384(0xC047),
    TLS_ECDHE_ECDSA_WITH_ARIA_128_CBC_SHA256(0xC048), TLS_ECDHE_ECDSA_WITH_ARIA_256_CBC_SHA384(0xC049),
    TLS_ECDH_ECDSA_WITH_ARIA_128_CBC_SHA256(0xC04A), TLS_ECDH_ECDSA_WITH_ARIA_256_CBC_SHA384(0xC04B),
    TLS_ECDHE_RSA_WITH_ARIA_128_CBC_SHA256(0xC04C), TLS_ECDHE_RSA_WITH_ARIA_256_CBC_SHA384(0xC04D),
    TLS_ECDH_RSA_WITH_ARIA_128_CBC_SHA256(0xC04E), TLS_ECDH_RSA_WITH_ARIA_256_CBC_SHA384(0xC04F),
    TLS_RSA_WITH_ARIA_128_GCM_SHA256(0xC050), TLS_RSA_WITH_ARIA_256_GCM_SHA384(0xC051),
    TLS_DHE_RSA_WITH_ARIA_128_GCM_SHA256(0xC052), TLS_DHE_RSA_WITH_ARIA_256_GCM_SHA384(0xC053),
    TLS_DH_RSA_WITH_ARIA_128_GCM_SHA256(0xC054), TLS_DH_RSA_WITH_ARIA_256_GCM_SHA384(0xC055),
    TLS_DHE_DSS_WITH_ARIA_128_GCM_SHA256(0xC056), TLS_DHE_DSS_WITH_ARIA_256_GCM_SHA384(0xC057),
    TLS_DH_DSS_WITH_ARIA_128_GCM_SHA256(0xC058), TLS_DH_DSS_WITH_ARIA_256_GCM_SHA384(0xC059),
    TLS_DH_anon_WITH_ARIA_128_GCM_SHA256(0xC05A), TLS_DH_anon_WITH_ARIA_256_GCM_SHA384(0xC05B),
    TLS_ECDHE_ECDSA_WITH_ARIA_128_GCM_SHA256(0xC05C), TLS_ECDHE_ECDSA_WITH_ARIA_256_GCM_SHA384(0xC05D),
    TLS_ECDH_ECDSA_WITH_ARIA_128_GCM_SHA256(0xC05E), TLS_ECDH_ECDSA_WITH_ARIA_256_GCM_SHA384(0xC05F),
    ...
    // *************************************************************************
    TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256(0xCCA8), TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256(0xCCA9),
    ...
    // GREASE constants
    GREASE_00(0x0A0A), GREASE_01(0x1A1A), GREASE_02(0x2A2A), GREASE_03(0x3A3A), GREASE_04(0x4A4A), GREASE_05(0x5A5A),
    GREASE_06(0x6A6A), GREASE_07(0x7A7A), GREASE_08(0x8A8A), GREASE_09(0x9A9A), GREASE_10(0xAAAA), GREASE_11(0xBABA),
    GREASE_12(0xCACA), GREASE_13(0xDADA), GREASE_14(0xEAEA), GREASE_15(0xFAFA),
    TLS_GOSTR341112_256_WITH_28147_CNT_IMIT(0xFF85), TLS_GOSTR341112_256_WITH_NULL_GOSTR3411(0xFF87);
