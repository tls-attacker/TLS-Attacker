...
/**
 * Parses SmtpReplies from an InputStream.
 * The default implementation only parses the status code and the human readable message.
 * If more complex parsing is needed, the parseMessage method can be overridden.
 * Assumption:
