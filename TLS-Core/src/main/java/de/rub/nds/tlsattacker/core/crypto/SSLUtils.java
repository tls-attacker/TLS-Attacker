...
public class SSLUtils {
     ...
     *
     * @param  input
     *                        is the input for the chosen hashAlgorithm, which is (seq_num + SSLCompressed.type +
     *                        SSLCompressed.length + SSLCompressed.fragment) from the fully defined hashFunction in the
     *                        description.
