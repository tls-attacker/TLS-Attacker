...
public class TlsAttackerSocket {
    ...
    private final TlsContext context; //TODO Would be better if we could keep the context out of this
    ...
    {
        //If too many bytes we have to split this into multiple application messages TODO
    ...
    /**
     * Recieves bytes and decrypts ApplicationMessage contents in converts them to Strings
     * @return 
     * @throws java.io.IOException 
     */
