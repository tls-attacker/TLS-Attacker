        ...
        if (chooser.getConfig().getAutoAdjustSignatureAndHashAlgorithm()) {
            ...
            if (candidateList.isEmpty()) {
                if (chooser.getTalkingConnectionEnd() == ConnectionEndType.SERVER) {
                    ...
                    signHashAlgo = chooser.getClientSelectedSigHashAlgorithm();
                }
            } else {
            ...
            if (chooser.getTalkingConnectionEnd() == ConnectionEndType.SERVER) {
                signHashAlgo =
                        chooser.getConfig().getDefaultServerSelectedSignatureAndHashAlgorithm();
            } else {
                signHashAlgo =
                        chooser.getConfig().getDefaultClientSelectedSignatureAndHashAlgorithm();
            }
        }
        return signHashAlgo;
    }
