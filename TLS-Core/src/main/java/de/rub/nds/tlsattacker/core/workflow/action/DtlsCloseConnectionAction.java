...
public class DtlsCloseConnectionAction extends MessageAction implements SendingAction {
    ...
    public void execute(State state) throws WorkflowExecutionException {
        ...
        if (hasDefaultAlias()) {
            LOGGER.info("Sending Alert: " + sending);
        } else {
            LOGGER.info("Sending Alert (" + connectionAlias + "): " + sending);
        }
    ...
    public String toString() {
        StringBuilder sb;
        if (isExecuted()) {
            sb = new StringBuilder("Dtls Close Connection Action:\n");
        } else {
            sb = new StringBuilder("Dtls Close Connection Action: (not executed)\n");
        }
        sb.append("\tMessages:");
        if (messages != null) {
