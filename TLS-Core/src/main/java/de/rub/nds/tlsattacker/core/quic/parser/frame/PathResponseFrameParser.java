...
public class PathResponseFrameParser extends QuicFrameParser<PathResponseFrame> {
    ...
    @Override
    public void parse(PathResponseFrame pathResponseFrame) {
        parseData(pathResponseFrame);
    }

    protected void parseData(PathResponseFrame pathResponseFrame) {
        pathResponseFrame.setData(parseByteArrayField(8));
    }
}
