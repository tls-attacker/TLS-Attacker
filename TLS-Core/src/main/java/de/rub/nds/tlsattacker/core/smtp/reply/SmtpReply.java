...
public class SmtpReply extends SmtpMessage {
    ...
    /**
     * These are the outgoing lines for a reply. They are to be set in the prepare step of the reply
     * preparator and the serializer. They are NOT to be used for storing the abstracted contents of
     * a message.
     */
