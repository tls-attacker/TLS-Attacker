...
/**
 * GOST 28147-89 counter mode as defined in RFC 5830 with CryptoPro key meshing as defined in
 * RFC 4357.
 */
public class GOST28147Cipher implements EncryptionCipher, DecryptionCipher {

    private static final GOST28147ParameterSpec SPEC = new GOST28147ParameterSpec("E-A");
    ...
    public GOST28147Cipher(CipherAlgorithm algorithm, byte[] key, byte[] iv) {
