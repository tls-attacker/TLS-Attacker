...
public class Config implements Serializable {
    ...
    /**
     * If this is non-null, TLS-Attacker will not create its own certificate
     * chain but will simply send the bytes in the list as the certificates in
     * the chain in the provided order
     */
    ...
    /**
     * If set to true, dynamically creates certificates that are fit to use for
     * the current TLS connection. If set to false, certificates are either
     * generated as specified or the explicit certificate is used
     */
    ...
    private BigInteger defaultEcdsaNonce
            = new BigInteger(
                    1,
                    ArrayConverter.hexStringToByteArray(
                            "636174202F6465762F72616E646F6D3F"));
    ...
    /**
     * Every record will be sent in one individual transport packet [ADD FOR
     * LAYER!]
     */
     ...
     * connection, e.g. no received HttpRequestMessage or httpParsing is
     * disabled
     */
    @XmlJavaTypeAdapter(IllegalStringAdapter.class)
