...
import de.rub.nds.tlsattacker.core.ice.IceConfig;
...
public class Config implements Serializable {
    ...
    private SignatureAndHashAlgorithm defaultServerSelectedSignatureAndHashAlgorithm = SignatureAndHashAlgorithm.RSA_SHA1;

    private SignatureAndHashAlgorithm defaultClientSelectedSignatureAndHashAlgorithm = SignatureAndHashAlgorithm.RSA_SHA1;
    ...
    public X509CertificateConfig getDefaultX509CertificateConfig() {
        if (certificateChainConfig.isEmpty()) {
            throw new RuntimeException(
                    "No cerfificate chain config available. Invalid configuration");
        }
        return certificateChainConfig.get(0);
    }
    ...
    public void setDefaultClientSelectedSignatureAndHashAlgorithm(
        ...
        this.defaultClientSelectedSignatureAndHashAlgorithm = defaultClientSelectedSignatureAndHashAlgorithm;
    }
        ...
        for (X509Certificate cert : defaultExplicitCertificateChain.getCertificateList()) {
            certBytes.add(
                    new CertificateBytes(
                            cert.getSerializer(
                                    new X509Chooser(
                                            getDefaultX509CertificateConfig(),
                                            new X509Context()))
                                    .serialize()));
        }
    ...
    public void setDefaultServerSelectedSignatureAndHashAlgorithm(
        ...
        this.defaultServerSelectedSignatureAndHashAlgorithm = defaultSelectedSignatureAndHashAlgorithm;
    }
