...
public enum SignatureAndHashAlgorithm {
    ANONYMOUS_NONE(0x0000), ANONYMOUS_MD5(0x0100), ANONYMOUS_SHA1(0x0200), ANONYMOUS_SHA224(0x0300), ANONYMOUS_SHA256(
        0x0400), ANONYMOUS_SHA384(0x0500), ANONYMOUS_SHA512(0x0600), RSA_NONE(0x0001), RSA_MD5(0x0101),
    RSA_SHA1(0x0201), RSA_SHA224(0x0301), RSA_SHA256(0x0401), RSA_SHA384(0x0501), RSA_SHA512(0x0601), DSA_NONE(0x0002),
    DSA_MD5(0x0102), DSA_SHA1(0x0202), DSA_SHA224(0x0302), DSA_SHA256(0x0402), DSA_SHA384(0x0502), DSA_SHA512(0x0602),
    ECDSA_NONE(0x0003), ECDSA_MD5(0x0103), ECDSA_SHA1(0x0203), ECDSA_SHA224(0x0303), ECDSA_SHA256(0x0403),
    ECDSA_SHA384(0x0503), ECDSA_SHA512(0x0603), ED25519(0x0807), ED448(0x0808),
    ...
    GOSTR34102001_GOSTR3411(0xEDED), GOSTR34102012_256_GOSTR34112012_256(0xEEEE), GOSTR34102012_512_GOSTR34112012_512(
        0xEFEF);
