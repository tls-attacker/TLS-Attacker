...
public class DHEServerKeyExchangeHandler extends HandshakeMessageHandler<DHEServerKeyExchangeMessage> {
    ...
    // int pLength = ArrayConverter.bytesToInt(Arrays.copyOfRange(message,
    // currentPointer, nextPointer));
    ...
    // currentPointer = nextPointer;
    // nextPointer = currentPointer + HandshakeByteLength.DH_PARAM_LENGTH;
    // int gLength = ArrayConverter.bytesToInt(Arrays.copyOfRange(message,
    // currentPointer, nextPointer));
    ...
    // byte[] pkBytes = Arrays.copyOfRange(message, currentPointer,
    // nextPointer);
    ...
    // BigIntegers.asUnsignedByteArray(protocolMessage.getP()
    // .getValue()),
    // ArrayConverter.intToBytes(protocolMessage.getgLength().getValue(),
    // HandshakeByteLength.DH_PARAM_LENGTH),
    // BigIntegers.asUnsignedByteArray(protocolMessage.getG()
    // .getValue()),
    // ArrayConverter.intToBytes(protocolMessage.getPublicKeyLength().getValue(),
    // HandshakeByteLength.DH_PARAM_LENGTH),
    // BigIntegers.asUnsignedByteArray(protocolMessage
    ...
    //
    // KeyGenerationParameters kgp = new DHKeyGenerationParameters(new
    // SecureRandom(), params);
    ...
    //
    // byte[] dhParams =
    // ArrayConverter.concatenate(ArrayConverter.intToBytes(protocolMessage.getSerializedPLength()
    // .getValue(), HandshakeByteLength.DH_PARAM_LENGTH),
    ...
    // // certificate
    // SignatureAndHashAlgorithm selectedSignatureHashAlgo = new
    ...
    // ArrayConverter.concatenate(tlsContext.getClientRandom(),
    ...
    @Override
    protected Preparator getPreparator(DHEServerKeyExchangeMessage message) {
        throw new UnsupportedOperationException("Not supported yet."); // To
                                                                       // change
                                                                       // body
                                                                       // of
