...
public abstract class HandshakeMessage<Self extends HandshakeMessage<?>> extends ProtocolMessage<Self> {
    ...
    @Override
    public abstract HandshakeMessageParser<Self> getParser(TlsContext tlsContext, InputStream stream);
