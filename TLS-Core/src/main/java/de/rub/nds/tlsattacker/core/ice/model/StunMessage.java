...
import de.rub.nds.tlsattacker.core.ice.handler.StunMessageHandler;
...
public class StunMessage extends IceMessage {
    ...
    private StunMethodType methodType;
    ...
    public String toShortString() {
        ...
        for (StunAttribute attribute : attributeList) {
            stringBuilder.append(attribute.toShortString());
