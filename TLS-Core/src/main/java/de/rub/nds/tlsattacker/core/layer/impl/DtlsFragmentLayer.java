...
public class DtlsFragmentLayer
     ...
     */
    @Override
    public LayerProcessingResult<DtlsHandshakeMessageFragment> sendConfigurationInternal()
            throws IOException {
     ...
     */
    @Override
    public LayerProcessingResult<DtlsHandshakeMessageFragment> sendDataInternal(
    ...
    @Override
    public LayerProcessingResult<DtlsHandshakeMessageFragment> receiveDataInternal() {
