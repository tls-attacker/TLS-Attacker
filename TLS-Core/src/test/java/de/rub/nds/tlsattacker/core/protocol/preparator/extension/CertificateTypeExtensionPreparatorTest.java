...
public class CertificateTypeExtensionPreparatorTest extends AbstractExtensionMessagePreparatorTest<
    ...
    public void testPrepare() {
        ...
        assertArrayEquals(ExtensionType.CERT_TYPE.getValue(), message.getExtensionType().getValue());
