...
public class SrtpExtensionPreparatorTest extends
    AbstractExtensionMessagePreparatorTest<SrtpExtensionMessage, SrtpExtensionSerializer, SrtpExtensionPreparator> {

    public SrtpExtensionPreparatorTest() {
        super(SrtpExtensionMessage::new, SrtpExtensionSerializer::new, SrtpExtensionPreparator::new);
    }

    @Test
    @Override
    public void testPrepare() {
        List<SrtpProtectionProfiles> profiles = Arrays.asList(SrtpProtectionProfiles.SRTP_AES128_CM_HMAC_SHA1_80,
            SrtpProtectionProfiles.SRTP_AES128_CM_HMAC_SHA1_32, SrtpProtectionProfiles.SRTP_NULL_HMAC_SHA1_80,
        ...
        assertArrayEquals(new byte[] { 0x00, 0x01, 0x00, 0x02, 0x00, 0x05, 0x00, 0x06 },
