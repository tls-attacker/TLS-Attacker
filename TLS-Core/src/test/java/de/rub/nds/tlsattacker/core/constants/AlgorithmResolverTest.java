...
public class AlgorithmResolverTest {
    ...
    public void testGetCipher() {
        ...
        assertTrue(AlgorithmResolver.getCipher(CipherSuite.TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256) == CipherAlgorithm.CHACHA20_POLY1305);
        assertTrue(AlgorithmResolver.getCipher(CipherSuite.TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256) == CipherAlgorithm.CHACHA20_POLY1305);
        assertTrue(AlgorithmResolver.getCipher(CipherSuite.TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256) == CipherAlgorithm.CHACHA20_POLY1305);
        assertTrue(AlgorithmResolver.getCipher(CipherSuite.UNOFFICIAL_TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256) == CipherAlgorithm.UNOFFICIAL_CHACHA20_POLY1305);
        assertTrue(AlgorithmResolver.getCipher(CipherSuite.UNOFFICIAL_TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256) == CipherAlgorithm.UNOFFICIAL_CHACHA20_POLY1305);
        assertTrue(AlgorithmResolver.getCipher(CipherSuite.UNOFFICIAL_TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256) == CipherAlgorithm.UNOFFICIAL_CHACHA20_POLY1305);
    }
