...
public class PWDClientKeyExchangePreparatorTest
    extends AbstractTlsMessagePreparatorTest<PWDClientKeyExchangeMessage, PWDClientKeyExchangePreparator> {
    ...
    private static final byte[] scalar =
        ArrayConverter.hexStringToByteArray("46D60B797558FACE1E8243463DC0C16D3324FEA8BE7C0BEC87FB1E1D4EB7CE59");

    private static final byte[] element = ArrayConverter.hexStringToByteArray(
    ...
    private static final byte[] premaster =
        ArrayConverter.hexStringToByteArray("3B29832D64C2359A955BBEE5A466F5C8E9D25529056729C2FFDE0E04DD9D11BE");

    public PWDClientKeyExchangePreparatorTest() {
        super(PWDClientKeyExchangeMessage::new, PWDClientKeyExchangeMessage::new, PWDClientKeyExchangePreparator::new);
        ...
        context.setServerPWDElement(PointFormatter.formatFromByteArray(NamedGroup.BRAINPOOLP256R1, element));
        context.getConfig().setDefaultClientPWDMask(
            ArrayConverter.hexStringToByteArray("3EBAF8986DA712C82BCD4D554BF0B54023C29B624DE9EF9C2F931EFC580F9AFB"));
        context.getConfig().setDefaultClientPWDPrivate(
            ArrayConverter.hexStringToByteArray("081B12E107B1E805F2B4F5F0F1D00C2D0F62634670921C505867FF20F6A8335E"));
    }
