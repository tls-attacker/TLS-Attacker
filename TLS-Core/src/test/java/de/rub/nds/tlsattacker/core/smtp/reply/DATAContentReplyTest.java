...
public class DATAContentReplyTest {
    ...
    public void testParse() {
        ...
        DATAContentReplyParser parser = new DATAContentReplyParser(new ByteArrayInputStream(stringMessage.getBytes(StandardCharsets.UTF_8)));
        parser.parse(reply);
    ...
    public void testvalidReplyCode() {
        ...
        for (String reply : validReplies) {
            DATAContentReplyParser parser = new DATAContentReplyParser(new ByteArrayInputStream(reply.getBytes(StandardCharsets.UTF_8)));
