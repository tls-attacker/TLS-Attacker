...
public class DHEServerKeyExchangeHandlerTest {
    ...
    // try {
    // ClassLoader loader =
    // DHEServerKeyExchangeHandlerTest.class.getClassLoader();
    ...
    // throw new
    // ConfigurationException("Something went wrong loading key from Keystore",
    // ex);
    // }
    ...
    //
    // assertEquals("Message type must be ServerKeyExchange",
    // HandshakeMessageType.SERVER_KEY_EXCHANGE,
    // message.getHandshakeMessageType());
    // assertEquals("Message length must be 185", new Integer(185),
    // message.getLength().getValue());
    // assertEquals("p length must be 64", new Integer(64),
    // message.getpLength().getValue());
    // assertEquals("g length must be ", new Integer(1),
    // message.getgLength().getValue());
    // assertEquals("g must be 2", new BigInteger("2"),
    // message.getG().getValue());
    //
    // assertEquals("Public key length is 64", new Integer(64),
    ...
    // assertEquals("Signature length must be 46", new Integer(46),
    // message.getSignatureLength().getValue());
    //
    // assertEquals("The pointer has to return the length of the protocol message",
    // testServerKeyExchangeDSA.length,
    // endPointer);
    // }
    //
    // @Test
    // public void testIsCorrectProtocolMessage() {
    // DHEServerKeyExchangeMessage sem = new DHEServerKeyExchangeMessage(new
    // TlsConfig());
    ...
    // HandshakeMessageType.SERVER_KEY_EXCHANGE,
    // message.getHandshakeMessageType());
    // assertEquals("p length must be 256", new Integer(256),
    // message.getSerializedPLength().getValue());
    // assertEquals("p must be pTest", pTest, message.getP().getValue());
    // assertEquals("g length must be 1", new Integer(1),
    // message.getSerializedGLength().getValue());
    // assertEquals("g must be 2", new BigInteger("2"),
    // message.getG().getValue());
    // assertEquals("Public key length is 256", new Integer(256),
    ...
    // SignatureAlgorithm.getSignatureAlgorithm(message.getSignatureAlgorithm().getValue()));
    // assertEquals("Signature length must be 128", new Integer(128),
    // message.getSignatureLength().getValue());
    //
    // }
}
