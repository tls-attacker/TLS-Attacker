...
public class DHClientKeyExchangeParserTest {
    ...
    public DHClientKeyExchangeParserTest(byte[] message, HandshakeMessageType type, int length, int serializedKeyLength,
        byte[] serializedKey, ProtocolVersion version) {
    ...
    public void testParse() {
        DHClientKeyExchangeParser<DHClientKeyExchangeMessage> parser =
            new DHClientKeyExchangeParser(0, message, version, config);
