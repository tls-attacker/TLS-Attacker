...
public class ClientCertificateTypeExtensionParserTest
    ...
    public ClientCertificateTypeExtensionParserTest() {
        super(ClientCertificateTypeExtensionParser::new,
            List.of(
