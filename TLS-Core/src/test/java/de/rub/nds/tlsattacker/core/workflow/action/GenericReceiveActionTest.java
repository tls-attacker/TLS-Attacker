...
public class GenericReceiveActionTest {
    ...
    /**
     * Test of execute method, of class GenericReceiveAction with multiple messages.
     */
    @Test
    public void testExecuteMultipleInOneRecord() throws Exception {
        ...
        testActionMultipleMessages();
    }

    /**
     * Test of execute method, of class GenericReceiveAction with multiple messages in separate records.
     */
    @Test
    ...
    private void testActionMultipleMessages() {
        action.execute(state);
        assertTrue(action.executedAsPlanned());
        assertTrue(action.isExecuted());
