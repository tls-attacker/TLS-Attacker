...
public class ECDHEServerKeyExchangeSerializerTest extends AbstractHandshakeMessageSerializerTest<
    ECDHEServerKeyExchangeMessage, ECDHEServerKeyExchangeSerializer<ECDHEServerKeyExchangeMessage>> {

    public ECDHEServerKeyExchangeSerializerTest() {
        super(ECDHEServerKeyExchangeMessage::new, ECDHEServerKeyExchangeSerializer::new,
            List.of((msg, obj) -> msg.setCurveType((Byte) obj), (msg, obj) -> msg.setNamedGroup((byte[]) obj),
