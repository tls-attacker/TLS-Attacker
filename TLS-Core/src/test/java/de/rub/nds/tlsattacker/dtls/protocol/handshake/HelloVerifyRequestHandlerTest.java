...
public class HelloVerifyRequestHandlerTest {
    ...
    // HelloVerifyRequestMessage message = (HelloVerifyRequestMessage)
    ...
    // new byte[] { HandshakeMessageType.HELLO_VERIFY_REQUEST.getValue() }, new
    // byte[] { 0x00, 0x00, 0x06,
    // 0x01, (byte) 0xF4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06 },
    // config.getHighestProtocolVersion()
    // .getValue(), new byte[] { message.getCookieLength().getValue() },
    // message.getCookie()
    // .getValue());
    //
    ...
    //
    // int endPointer = 0;
    // endPointer = handler.parseMessage(helloVerifyRequestMessageBytes,
    // endPointer);
    //
    // HelloVerifyRequestMessage message = (HelloVerifyRequestMessage)
    // handler.getProtocolMessage();
    ...
    //
    // assertEquals("Check message type",
    // HandshakeMessageType.HELLO_VERIFY_REQUEST,
    // message.getHandshakeMessageType());
    // assertEquals("Message length should be 7 bytes", new Integer(7),
    ...
    // HandshakeMessageType.HELLO_VERIFY_REQUEST,
    // message.getHandshakeMessageType());
    // assertEquals("Message length should be 11 bytes", new Integer(11),
    // message.getLength().getValue());
    // assertArrayEquals("Check Protocol Version",
    // ProtocolVersion.DTLS12.getValue(), message.getProtocolVersion()
    // .getValue());
    ...
    // HandshakeMessageType.HELLO_VERIFY_REQUEST,
    // message.getHandshakeMessageType());
    // assertEquals("Message length should be 257 bytes", new Integer(257),
    // message.getLength().getValue());
    // assertArrayEquals("Check Protocol Version",
    // ProtocolVersion.DTLS12.getValue(), message.getProtocolVersion()
    // .getValue());
