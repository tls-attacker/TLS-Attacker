...
public class KeyShareExtensionPreparatorTest {
    ...
    public void setUp() {
        ...
        preparator =
            new KeyShareExtensionPreparator(context.getChooser(), message, new KeyShareExtensionSerializer(message,
    ...
    public void testPrepare() {
        ...
        KeyShareEntry entry =
            new KeyShareEntry(NamedGroup.ECDH_X25519, new BigInteger(
        ...
        preparator.prepare();
        assertArrayEquals(message.getKeyShareListBytes().getValue(),
            ArrayConverter
    ...
    public void testPreparePWD() {
        ...
        assertArrayEquals(ArrayConverter.hexStringToByteArray(("00 1A 00 61 9E E1 7F 2E  CF 74 02 8F 6C 1F D7 0D\n"
            ...
            + "84 A9 DB 5B B8 24 FC 39  82 42 8F CD 40 69 63 AE\n" + "08 0E 67 7A 48").replaceAll("\\s+", "")), message
            .getKeyShareListBytes().getValue());
    }
