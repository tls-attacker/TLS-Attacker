...
public class DHEServerKeyExchangeParserTest extends AbstractHandshakeMessageParserTest<DHEServerKeyExchangeMessage,
    DHEServerKeyExchangeParser<DHEServerKeyExchangeMessage>> {

    public DHEServerKeyExchangeParserTest() {
        super(DHEServerKeyExchangeMessage.class, DHEServerKeyExchangeParser::new,
            List.of(
                Named.of("DHEServerKeyExchangeMessage::getModulusLength",
    ...
    public static Stream<Arguments> provideTestVectors() {
        return Stream.of(Arguments.of(ProtocolVersion.TLS12, ArrayConverter.hexStringToByteArray(
            ...
            List.of(HandshakeMessageType.SERVER_KEY_EXCHANGE.getValue(), 779, 256, ArrayConverter.hexStringToByteArray(
            ...
            Arguments.of(ProtocolVersion.TLS10, ArrayConverter.hexStringToByteArray(
                ...
                Arrays.asList(HandshakeMessageType.SERVER_KEY_EXCHANGE.getValue(), 777, 256,
                    ArrayConverter.hexStringToByteArray(
                        ""),
                    1, ArrayConverter.hexStringToByteArray("02"), 256,
                    ArrayConverter.hexStringToByteArray(
