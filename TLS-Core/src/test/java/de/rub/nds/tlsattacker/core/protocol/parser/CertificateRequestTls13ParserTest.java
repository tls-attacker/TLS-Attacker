...
public class CertificateRequestTls13ParserTest {
    ...
    public static Collection<Object[]> generateData() {
        return Arrays
                .asList(new Object[][] { {
                        ArrayConverter
                                .hexStringToByteArray("0d0000020102"),
                        0,
                        ArrayConverter
                                .hexStringToByteArray("0d0000020102"),
                        2,
    ...
    public CertificateRequestTls13ParserTest(byte[] message, int start, byte[] expectedPart, int length, HandshakeMessageType type,
