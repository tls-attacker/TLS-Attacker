...
public class CertificateStatusRequestV2ExtensionParserTest extends
    ...
    public CertificateStatusRequestV2ExtensionParserTest() {
        super(CertificateStatusRequestV2ExtensionParser::new,
            List.of(
                ...
                Named.of("CertificateStatusRequestV2ExtensionMessage::getStatusRequestBytes",
                    CertificateStatusRequestV2ExtensionMessage::getStatusRequestBytes)));
    }

    public static Stream<Arguments> provideTestVectors() {
        List<ResponderId> responderIdList = List.of(new ResponderId(3, new byte[] { 0x01, 0x02, 0x03 }),
        ...
        List<RequestItemV2> requestItems =
            List.of(new RequestItemV2(1, 21, 0xb, 6, hexStringToByteArray("010203040506")),
    ...
    protected void assertExtensionMessageSpecific(List<Object> providedAdditionalValues,
        ...
        assertRequestItemV2List((List<RequestItemV2>) expectedMessageSpecificValues.get(2),
    ...
    public static void assertRequestItemV2List(List<RequestItemV2> listExpected, List<RequestItemV2> listActual) {
        ...
        for (int i = 0; i < listExpected.size(); i++) {
            ...
            assertArrayEquals(itemExpected.getRequestExtensions().getValue(),
                itemActual.getRequestExtensions().getValue());
            assertEquals(itemExpected.getRequestExtensionsLength().getValue(),
            ...
            if (itemExpected.getResponderIdListBytes() != null
                ...
                assertArrayEquals(itemExpected.getResponderIdListBytes().getValue(),
                    itemActual.getResponderIdListBytes().getValue());
            } else {
                assertNull(itemActual.getResponderIdListBytes());
            }
            assertEquals(itemExpected.getResponderIdListLength().getValue(),
