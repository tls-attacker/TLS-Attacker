...
public class TokenbindingMessagePreparatorTest {
        ...
        public void setUp() {
                config = new Config();
                TlsContext context = new Context(new State(config), new InboundConnection()).getTlsContext();
        ...
        public void testPrepareProtocolMessageContents() {
                ...
                TokenBindingMessageParser selfParser = new TokenBindingMessageParser(
                                new ByteArrayInputStream(serialize));
