...
public class CertificateStatusRequestV2ExtensionPreparatorTest
    extends AbstractExtensionMessagePreparatorTest<CertificateStatusRequestV2ExtensionMessage,
        CertificateStatusRequestV2ExtensionSerializer, CertificateStatusRequestV2ExtensionPreparator> {

    public CertificateStatusRequestV2ExtensionPreparatorTest() {
        super(CertificateStatusRequestV2ExtensionMessage::new, CertificateStatusRequestV2ExtensionMessage::new,
            CertificateStatusRequestV2ExtensionSerializer::new, CertificateStatusRequestV2ExtensionPreparator::new);
    }
    ...
    public void testPrepare() {
        ...
        for (ResponderId item : respList) {
            ResponderIdPreparator idPreparator = new ResponderIdPreparator(context.getChooser(), item);
            idPreparator.prepare();
        }

        for (RequestItemV2 item : list) {
            RequestItemV2Preparator itemPreparator = new RequestItemV2Preparator(context.getChooser(), item);
        ...
        CertificateStatusRequestV2ExtensionParserTest.assertRequestItemV2List(list, message.getStatusRequestList());
