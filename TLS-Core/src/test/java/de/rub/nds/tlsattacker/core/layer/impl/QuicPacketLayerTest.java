...
public class QuicPacketLayerTest {
    ...
    private final byte[] sourceConnectionId = ArrayConverter.hexStringToByteArray("1d541e5371a5e1c6c481b6d7b07f0961");
    private final byte[] destinationConnectionId = ArrayConverter
            .hexStringToByteArray("8bf5abc395aa5e36e8c0b304a1352aa5");

    private final byte[] initialPacketWithClientHello = ArrayConverter.hexStringToByteArray(
    ...
    private final byte[] clientHelloInStreamFrame = ArrayConverter.hexStringToByteArray(
    ...
    public void testSendConfiguration() throws IOException {
        ...
        for (int i = 0; i < quicPackets.size(); i++) {
            ...
            List<QuicPacket> usedContainers = tlsContext
                    .getLayerStack()
                    .getLayer(QuicPacketLayer.class)
                    .getLayerResult()
                    .getUsedContainers();
