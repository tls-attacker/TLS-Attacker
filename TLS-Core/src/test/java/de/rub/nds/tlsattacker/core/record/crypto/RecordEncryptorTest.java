...
public class RecordEncryptorTest {
    ...
    public void testEncryptTLS12Block() throws NoSuchAlgorithmException, CryptoException {
        ...
        context.setClientRandom(
            ArrayConverter.hexStringToByteArray("EB9DB77B60B420BB3851D9D47ACB933DBE70399BF6C92DA33AF01D4FB770E98C"));
        context.setServerRandom(
            ArrayConverter.hexStringToByteArray("59D5EAEF4D34A1FC14E3417E6ED24FD5FB39B5009D9CB3181CECDAFB46D1EBD4"));
        ...
        assertArrayEquals(ArrayConverter.hexStringToByteArray("1400000CB692015BE123B8364314FE1C"),
            record.getComputations().getAuthenticatedNonMetaData().getValue());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("BD527A01EDCA68BF5A7918C190942A9AECA971CA"),
    ...
    public void testEncryptTLS12Camellia() throws NoSuchAlgorithmException, CryptoException {
        context.setRandom(new TestRandomData(ArrayConverter.hexStringToByteArray("16B406CF7A489CA985883AEDA28D34E3")));
        context.setSelectedProtocolVersion(ProtocolVersion.TLS12);
        ...
        assertArrayEquals(ArrayConverter.hexStringToByteArray("16B406CF7A489CA985883AEDA28D34E3"), // 4ED3256F1B380C692B962DF892180C5A
            record.getComputations().getCbcInitialisationVector().getValue());
    ...
    public void testEncryptTLS10GOST() throws NoSuchAlgorithmException, CryptoException {
        ...
        context.setClientRandom(
            ArrayConverter.hexStringToByteArray("52E78F4F6AA0FE312217AEF691AD763932945E8CEDD7F96E3C336B0866A66698"));
        context.setServerRandom(
            ArrayConverter.hexStringToByteArray("52E78F4F4E131F8CABAFD5D7C9C62A5EDF62CADB4D033131FE9B83DE9D459EFD"));
    ...
    public void testEncryptTLS12Stream() throws NoSuchAlgorithmException, CryptoException {
        ...
        context.setClientRandom(
            ArrayConverter.hexStringToByteArray("1669F42460B420BB3851D9D47ACB933DBE70399BF6C92DA33AF01D4FB770E98C"));
        context.setServerRandom(
            ArrayConverter.hexStringToByteArray("A36EF73D371D709E9ED42DDA38DA8F750AD4BB6D21D4E496A22A20BD6349EFFA"));
        ...
        assertArrayEquals(ArrayConverter.hexStringToByteArray("00000000000000001603030010"),
            record.getComputations().getAuthenticatedMetaData().getValue());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("CE4D3A05054892056A014B28E3AF613105583FAA"),
            record.getComputations().getMac().getValue());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("1400000CDF6663DF2F42C83E1EA94381"),
            record.getComputations().getAuthenticatedNonMetaData().getValue());
    ...
    public void testEncryptTLS12AEAD() throws NoSuchAlgorithmException, CryptoException {
        ...
        context.setClientRandom(
            ArrayConverter.hexStringToByteArray("167D244D60B420BB3851D9D47ACB933DBE70399BF6C92DA33AF01D4FB770E98C"));
        context.setServerRandom(
            ArrayConverter.hexStringToByteArray("41C2F030D70B2944BE2B1905BB8488C873E056B030413788D5D1ECADC17C3C39"));
        ...
        assertArrayEquals(ArrayConverter.hexStringToByteArray("FA78825C25329563CD9FEDFBE49AF948"),
            record.getComputations().getAuthenticatedNonMetaData().getValue());
        assertNull(record.getComputations().getPadding());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("1400000C0C821172BB87E255D5C6E078"),
            record.getComputations().getPlainRecordBytes().getValue());
        assertNull(record.getComputations().getCbcInitialisationVector());
        assertNull(record.getComputations().getAdditionalPaddingLength());
        assertArrayEquals(record.getProtocolMessageBytes().getValue(), ArrayConverter
    ...
    public void testEncryptTLS10Block() throws NoSuchAlgorithmException, CryptoException {
        ...
        context.setClientRandom(
            ArrayConverter.hexStringToByteArray("19D50C2360B420BB3851D9D47ACB933DBE70399BF6C92DA33AF01D4FB770E98C"));
        context.setServerRandom(
            ArrayConverter.hexStringToByteArray("D4370EDB60688FCF49CA9C3A81B55B5E347E0CFC4323FB7196257B17BE344723"));
        ...
        assertArrayEquals(ArrayConverter.hexStringToByteArray("00000000000000001603010010"),
            record.getComputations().getAuthenticatedMetaData().getValue());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("F4CA3F8A11CE20E1D9BE67BE9B49C2E9305035D0"),
            record.getComputations().getMac().getValue());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("1400000CD424FAF2BEA85BCE69DC07D2"),
            record.getComputations().getAuthenticatedNonMetaData().getValue());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("0B0B0B0B0B0B0B0B0B0B0B0B"),
            record.getComputations().getPadding().getValue());
        assertArrayEquals(
            ...
            record.getComputations().getPlainRecordBytes().getValue());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("A8CD0618E71B0F32F5119960197F6864"),
            record.getComputations().getCbcInitialisationVector().getValue());
        assertArrayEquals(record.getProtocolMessageBytes().getValue(), ArrayConverter.hexStringToByteArray(
    ...
    public void testEncryptTLS10Stream() throws NoSuchAlgorithmException, CryptoException {
        ...
        context.setClientRandom(
            ArrayConverter.hexStringToByteArray("19EBAD6060B420BB3851D9D47ACB933DBE70399BF6C92DA33AF01D4FB770E98C"));
        context.setServerRandom(
            ArrayConverter.hexStringToByteArray("38EC0B0DC6860F09D55DFE8188ACD81D31E0AFD0BD1EF7177C3FB0BC867271FD"));
        ...
        assertArrayEquals(ArrayConverter.hexStringToByteArray("00000000000000001603010010"),
            record.getComputations().getAuthenticatedMetaData().getValue());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("4BD82D0657D876744D05455125FF0BE1F7FA293D"),
            record.getComputations().getMac().getValue());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("1400000C5BD2239FEE954F5C5CC2A66D"),
            record.getComputations().getAuthenticatedNonMetaData().getValue());
        assertArrayEquals(
            ArrayConverter
