...
public class Quicv2Test {
    ...
    @Test
    public void versionDependendInitialSecretsTest()
        ...
        QuicContext quicv1Context = calculateSecretsForVersion(QuicVersion.VERSION_1);
        ...
        QuicContext quicv2Context = calculateSecretsForVersion(QuicVersion.VERSION_2);
        ...
        try {
            calculateSecretsForVersion(QuicVersion.NEGOTIATION_VERSION);
            assert false;
        } catch (UnsupportedOperationException e) {
            // This exception is what we expect
        }
        try {
            calculateSecretsForVersion(QuicVersion.NULL_VERSION);
            assert false;
        } catch (UnsupportedOperationException e) {
            // This exception is what we expect
        }
    ...
    private QuicContext calculateSecretsForVersion(QuicVersion version)
            throws NoSuchAlgorithmException, CryptoException, NoSuchPaddingException {
