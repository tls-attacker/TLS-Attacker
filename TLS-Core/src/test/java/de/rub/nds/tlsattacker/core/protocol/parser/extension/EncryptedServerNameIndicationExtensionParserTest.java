...
public class EncryptedServerNameIndicationExtensionParserTest extends AbstractExtensionParserTest<
    EncryptedServerNameIndicationExtensionMessage, EncryptedServerNameIndicationExtensionParser> {
    ...
    public EncryptedServerNameIndicationExtensionParserTest() {
        super(EncryptedServerNameIndicationExtensionParser::new, List.of(
            Named.of("EncryptedServerNameIndicationExtensionMessage::getEsniMessageTypeConfig",
                msg -> EncryptedServerNameIndicationExtensionMessage.EsniMessageType.CLIENT),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getCipherSuite",
                EncryptedServerNameIndicationExtensionMessage::getCipherSuite),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getKeyShareEntry::getGroup",
                msg -> msg.getKeyShareEntry().getGroup()),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getKeyShareEntry::getPublicKeyLength",
                msg -> msg.getKeyShareEntry().getPublicKeyLength()),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getKeyShareEntry::getPublicKey",
                msg -> msg.getKeyShareEntry().getPublicKey()),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getRecordDigestLength",
                EncryptedServerNameIndicationExtensionMessage::getRecordDigestLength),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getRecordDigest",
                EncryptedServerNameIndicationExtensionMessage::getRecordDigest),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getEncryptedSniLength",
                EncryptedServerNameIndicationExtensionMessage::getEncryptedSniLength),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getEncryptedSni",
                EncryptedServerNameIndicationExtensionMessage::getEncryptedSni),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getEncryptedSniComputation::getEsniSharedSecret",
                msg -> msg.getEncryptedSniComputation().getEsniSharedSecret()),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getEncryptedSniComputation::getEsniMasterSecret",
                msg -> msg.getEncryptedSniComputation().getEsniMasterSecret()),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getEncryptedSniComputation::getEsniContents",
                msg -> msg.getEncryptedSniComputation().getEsniContents()),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getEncryptedSniComputation::getEsniContentsHash",
                msg -> msg.getEncryptedSniComputation().getEsniContentsHash()),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getEncryptedSniComputation::getEsniKey",
                msg -> msg.getEncryptedSniComputation().getEsniKey()),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getEncryptedSniComputation::getEsniIv",
            ...
            Named.of("EncryptedServerNameIndicationExtensionMessage::getClientEsniInnerBytes",
                EncryptedServerNameIndicationExtensionMessage::getClientEsniInnerBytes),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getClientEsniInner::getClientNonce",
                msg -> msg.getClientEsniInner().getClientNonce()),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getClientEsniInner::getServerNameListLength",
                msg -> msg.getClientEsniInner().getServerNameListLength()),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getClientEsniInner::getServerNameListBytes",
                msg -> msg.getClientEsniInner().getServerNameListBytes()),
            Named.of("EncryptedServerNameIndicationExtensionMessage::getClientEsniInner::getPadding",
    ...
    public static Stream<Arguments> provideTestVectors() {
        ...
        serverKeyShareEntry.setPrivateKey(new BigInteger(
        ...
        return Stream.of(Arguments.of(ArrayConverter.hexStringToByteArray(
            ...
            List.of(List.of(serverKeyShareEntry),
                ...
                List.of(
                    new KeyShareStoreEntry(NamedGroup.ECDH_X25519,
                        ArrayConverter
                            .hexStringToByteArray("33f34944dd62f7d40388729b584e5eb108e29b34c739af29ec5113fb2b8d5714")),
                    new KeyShareStoreEntry(NamedGroup.SECP256R1, ArrayConverter.hexStringToByteArray(
            ...
            ExtensionType.ENCRYPTED_SERVER_NAME_INDICATION, 366,
            List.of(EncryptedServerNameIndicationExtensionMessage.EsniMessageType.CLIENT,
                ArrayConverter.hexStringToByteArray("1301"), ArrayConverter.hexStringToByteArray("001d"), 32,
                ...
                ArrayConverter.hexStringToByteArray("BD005945C1C69AA9F36944C4040C5558"),
                ...
                ArrayConverter.hexStringToByteArray("a7284c9a52f15c13644b947261774657"), 18,
                ArrayConverter.hexStringToByteArray("00000f62617a2e6578616d706c652e636f6d"), new byte[240], (byte) 0x00,
                15, ArrayConverter.hexStringToByteArray("62617a2e6578616d706c652e636f6d"))));
    }
    ...
    protected void assertExtensionMessageSpecific(List<Object> providedAdditionalValues,
        ...
        // noinspection unchecked
        context.setClientKeyShareStoreEntryList((List<KeyShareStoreEntry>) providedAdditionalValues.get(2));

        EncryptedServerNameIndicationExtensionPreparator preparator =
            new EncryptedServerNameIndicationExtensionPreparator(chooser, message, null);
