...
public class EncryptedServerNameIndicationExtensionParserTest {
    ...
    @Test
    public void test() {
        byte[] msgBytes = ArrayConverter
                .hexStringToByteArray("");

        byte[] serverPrivateKey = ArrayConverter
        ...
        byte[] clientRandom = ArrayConverter
                .hexStringToByteArray("e6aef9c483abf499f6a1c3befa5f16f854482072a0d3d29476c51f5c3d4d5709");

        byte[] clientKeySharePublicKey1 = ArrayConverter
                .hexStringToByteArray("33f34944dd62f7d40388729b584e5eb108e29b34c739af29ec5113fb2b8d5714");

        byte[] clientKeySharePublicKey2 = ArrayConverter
                .hexStringToByteArray("0401e31149fb03eee9a101c3660bb29db586d1a347414f0c28011a5fe4805a355d37edfec598888d76083580f0394e754a4666f9a66678c23ae2058ac2fa55a459");
        ...
        EncryptedServerNameIndicationExtensionParser parser = new EncryptedServerNameIndicationExtensionParser(0,
                msgBytes, context.getConfig());
        ...
        byte[] expectedClientPublicKey = ArrayConverter
        ...
        byte[] expectedEsniSharedSecret = ArrayConverter
        ...
        byte[] expectedEsniMasterSecret = ArrayConverter
        ...
        byte[] expectedEsniContents = ArrayConverter
        ...
        byte[] expectedEsniContentsHash = ArrayConverter
        ...
        int resultServerNameLength = msg.getClientEsniInner().getServerNameList().get(0).getServerNameLength()
                .getValue();
