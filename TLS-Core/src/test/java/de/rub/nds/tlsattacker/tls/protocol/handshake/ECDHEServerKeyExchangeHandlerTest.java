...
public class ECDHEServerKeyExchangeHandlerTest {
    ...
    //
    // int endPointer = handler.parseMessageAction(testServerKeyExchangeECDSA,
    // 0);
    ...
    // assertEquals("Message length must be 208", new Integer(208),
    // message.getLength().getValue());
    // assertEquals("Curve Type must be named curve",
    ...
    // assertEquals("Public key length is 145", new Integer(145),
    ...
    // HandshakeMessageType.SERVER_KEY_EXCHANGE,
    // message.getHandshakeMessageType());
    // assertEquals("Message length must be 281", new Integer(281),
    // message.getLength().getValue());
    // assertEquals("Curve Type must be named curve",
    // EllipticCurveType.NAMED_CURVE,
    // EllipticCurveType.getCurveType(message.getCurveType().getValue()));
    ...
    //
    // assertEquals("The pointer has to return the length of the protocol message",
    // testServerKeyExchangeRSA.length,
    // endPointer);
    // }
    //
    // @Test
    // public void testIsCorrectProtocolMessage() {
    // ECDHEServerKeyExchangeMessage sem = new ECDHEServerKeyExchangeMessage(new
    // TlsConfig());
