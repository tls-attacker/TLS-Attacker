...
public class EmptyClientKeyExchangePreparatorTest {
    ...
    private final String DH_CLIENT_CERT = "-----BEGIN CERTIFICATE-----\n"
    ...
    private final BigInteger DH_SERVER_PUBLIC_KEY = new BigInteger(
            ...
            16);
    private final byte[] DH_PREMASTER = ArrayConverter
            .hexStringToByteArray("");

    private final String EC_CLIENT_CERT = "-----BEGIN CERTIFICATE-----\n"
            ...
            + "-----END CERTIFICATE-----";
    private final BigInteger EC_CLIENT_PRIVATE_KEY = new BigInteger(
            "ec20862b9bbfa1d27ac4654cbf4ed38858562827e8e75408366288d1e252ba6d", 16);
    private final byte[] EC_SERVER_PUBLIC_KEY_BYTES = ArrayConverter
    ...
    private final byte[] EC_PREMASTER = ArrayConverter
            .hexStringToByteArray("26d7439f907fbd24408203579f7c712b04ee2aa55e62734adda2ecb904c6da0a");
