...
public class ECDHEServerKeyExchangeParserTest {
    ...
    public static Collection<Object[]> generateData() {
        return Arrays.asList(new Object[][] { { ArrayConverter.hexStringToByteArray(
            ...
            HandshakeMessageType.SERVER_KEY_EXCHANGE, 144, (byte) 0x03, ArrayConverter.hexStringToByteArray("0017"), 65,
            ...
            { ArrayConverter.hexStringToByteArray(
                ...
                HandshakeMessageType.SERVER_KEY_EXCHANGE, 327, (byte) 0x03, ArrayConverter.hexStringToByteArray("0017"),
                65,
                ArrayConverter.hexStringToByteArray(
