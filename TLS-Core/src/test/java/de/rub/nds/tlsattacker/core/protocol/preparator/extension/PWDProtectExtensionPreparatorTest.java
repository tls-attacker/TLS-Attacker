...
public class PWDProtectExtensionPreparatorTest extends AbstractExtensionMessagePreparatorTest<
    ...
    public PWDProtectExtensionPreparatorTest() {
        super(PWDProtectExtensionMessage::new, PWDProtectExtensionSerializer::new, PWDProtectExtensionPreparator::new);
    }
