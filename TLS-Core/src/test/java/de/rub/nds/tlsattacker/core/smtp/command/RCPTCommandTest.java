...
public class RCPTCommandTest {
    ...
    void testParsePostmaster() {
        ...
        assertEquals("<postmaster>", rcpt.getParameters());
    ...
    void testParsePostmasterDomain() {
        ...
        parser.parse(rcpt);
        assertEquals("RCPT", rcpt.getVerb());
        assertEquals("<seal@upb.de>", rcpt.getParameters());
    ...
    void testParseSpecialCase() {
        ...
        parser.parse(rcpt);
        assertEquals("RCPT", rcpt.getVerb());
        assertEquals("<'*+-/=?^_`{|}~#$@nice.org>", rcpt.getParameters());
    ...
    void testParseIPV6() {
        ...
        parser.parse(rcpt);
        assertEquals("RCPT", rcpt.getVerb());
        assertEquals("<test@[IPv6:2001:470:30:84:e276:63ff:fe72:3900]>", rcpt.getParameters());
    ...
    void testParseIPV4() {
        ...
        parser.parse(rcpt);
        assertEquals("RCPT", rcpt.getVerb());
        assertEquals("<seal@[166.84.7.99]>", rcpt.getParameters());
    ...
    void testParseWorstCase() {
        ...
        parser.parse(rcpt);
        assertEquals("RCPT", rcpt.getVerb());
        assertEquals("<\"\\@\\@\\@\\@\\@\"@gmail.com>", rcpt.getParameters());
    ...
    void testParseInvalidDomain() {
        ...
        parser.parse(rcpt);
        assertEquals("RCPT", rcpt.getVerb());
        assertEquals("<nicerdicer@>", rcpt.getParameters());
        assertEquals("<nicerdicer@>", rcpt.getRecipient());
        assertFalse(rcpt.isValidRecipient());
    }
