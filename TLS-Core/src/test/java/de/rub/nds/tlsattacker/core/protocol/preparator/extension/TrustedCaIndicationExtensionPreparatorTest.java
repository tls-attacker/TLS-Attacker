...
public class TrustedCaIndicationExtensionPreparatorTest
    ...
    public TrustedCaIndicationExtensionPreparatorTest() {
        super(TrustedCaIndicationExtensionMessage::new, TrustedCaIndicationExtensionMessage::new,
            TrustedCaIndicationExtensionSerializer::new, TrustedCaIndicationExtensionPreparator::new);
    }
