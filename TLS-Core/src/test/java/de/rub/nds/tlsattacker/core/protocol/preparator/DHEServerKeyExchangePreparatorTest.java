...
public class DHEServerKeyExchangePreparatorTest {
    ...
    public void testPrepare() {
        context.getConfig().setDefaultServerDhGenerator(new BigInteger(ArrayConverter.hexStringToByteArray(
        ...
        context.getConfig().setDefaultServerDhModulus(new BigInteger(1, ArrayConverter.hexStringToByteArray(
        ...
        assertArrayEquals(ArrayConverter.hexStringToByteArray("AABBCCDDAABBCCDD"),
            message.getComputations().getClientServerRandom().getValue());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("0201"),
