...
public class UnknownExtensionParserTest
    ...
    public UnknownExtensionParserTest() {
        super(UnknownExtensionMessage.class, UnknownExtensionParser::new,
    ...
    public static Stream<Arguments> provideTestVectors() {
        return Stream.of(
            Arguments.of(ArrayConverter.hexStringToByteArray("00230000"), List.of(),
                ArrayConverter.hexStringToByteArray("0023"), 0, Collections.singletonList(new byte[0])),
            ...
            Arguments.of(ArrayConverter.hexStringToByteArray("00000000"), List.of(),
                ArrayConverter.hexStringToByteArray("0000"), 0, Collections.singletonList(new byte[0])),
            Arguments.of(ArrayConverter.hexStringToByteArray("0000FFFF"), List.of(),
                ArrayConverter.hexStringToByteArray("0000"), 0xFFFF, Collections.singletonList(new byte[0])));
    }
}
