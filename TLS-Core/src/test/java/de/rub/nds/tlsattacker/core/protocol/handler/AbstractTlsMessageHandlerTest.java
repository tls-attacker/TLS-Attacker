...
abstract class AbstractTlsMessageHandlerTest<MT extends ProtocolMessage, HT extends ProtocolMessageHandler<MT>> {
    ...
    public void testGetParser() {
        assertNotNull(messageConstructor.get().getParser(context, new ByteArrayInputStream(new byte[0])));
    }
