...
public class PWDClientKeyExchangeSerializerTest {
    ...
    public void serializeHandshakeMessageContent() {
        byte[] message =
            ArrayConverter.hexStringToByteArray(("10 00 00 63 41 04 a0 c6 9b 45 0b\n"
        ...
        byte[] element =
            ArrayConverter.hexStringToByteArray(("04 a0 c6 9b 45 0b 85 ae e3 9f 64 6b 6e 64 d3 c1\n"
        ...
        byte[] scalar =
            ArrayConverter.hexStringToByteArray(("66 92 44 aa 67 cb 00 ea 72 c0 9b 84 a9 db 5b b8\n"
