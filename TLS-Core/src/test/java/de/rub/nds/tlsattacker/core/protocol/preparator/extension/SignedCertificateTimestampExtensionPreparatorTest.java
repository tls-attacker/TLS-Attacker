...
public class SignedCertificateTimestampExtensionPreparatorTest
    extends AbstractExtensionMessagePreparatorTest<SignedCertificateTimestampExtensionMessage,
        SignedCertificateTimestampExtensionSerializer, SignedCertificateTimestampExtensionPreparator> {

    public SignedCertificateTimestampExtensionPreparatorTest() {
        super(SignedCertificateTimestampExtensionMessage::new, SignedCertificateTimestampExtensionMessage::new,
            SignedCertificateTimestampExtensionSerializer::new, SignedCertificateTimestampExtensionPreparator::new);
    }

    @Test
    @Override
    public void testPrepare() {
        byte[] timestamp = ArrayConverter.hexStringToByteArray(
            "00ef007500ee4bbdb775ce60" + "bae142691fabe19e66a30f7e5fb072d8" + "8300c47b897aa8fdcb0000015b8fdb11"
