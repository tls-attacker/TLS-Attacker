...
public class NamedGroupsDelegateTest extends AbstractDelegateTest<NamedGroupsDelegate> {
    ...
    public void testSetPointFormats() {
        ...
        assertEquals(supportedPointFormats, delegate.getPointFormats(), "PointFormats setter is not working correctly");
    }
    ...
    public void testGetNamedCurves() {
        ...
        jcommander.parse(args);
        assertTrue(delegate.getNamedGroups().contains(NamedGroup.SECP192R1), "SECP192R1 should get parsed correctly");
        assertTrue(delegate.getNamedGroups().contains(NamedGroup.SECP256R1), "SECP256R1 should get parsed correctly");
    }
    ...
    public void testSetNamedCurves() {
        ...
        assertEquals(supportedNamedCurves, delegate.getNamedGroups(), "NamedCurves setter is not working correctly");
    }
    ...
    public void testApplyDelegate() {
        ...
        assertTrue(config.getDefaultClientNamedGroups().contains(NamedGroup.SECP192R1),
        ...
        assertTrue(config.getDefaultClientSupportedPointFormats().contains(ECPointFormat.UNCOMPRESSED),
            "UNCOMPRESSED should get parsed correctly");
        assertTrue(config.getDefaultClientSupportedPointFormats().contains(ECPointFormat.ANSIX962_COMPRESSED_PRIME),
            "ANSIX962_COMPRESSED_PRIME should get parsed correctly");
        assertTrue(config.getDefaultServerSupportedPointFormats().contains(ECPointFormat.UNCOMPRESSED),
            "UNCOMPRESSED should get parsed correctly");
        assertTrue(config.getDefaultServerSupportedPointFormats().contains(ECPointFormat.ANSIX962_COMPRESSED_PRIME),
            "ANSIX962_COMPRESSED_PRIME should get parsed correctly");
