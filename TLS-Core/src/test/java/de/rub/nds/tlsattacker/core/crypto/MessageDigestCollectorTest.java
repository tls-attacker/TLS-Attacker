...
public class MessageDigestCollectorTest {
    ...
    /**
     * Provides test vectors of format (providedProtocolVersion, providedCipherSuite) for
     * {@link #testDigest(ProtocolVersion, CipherSuite)}.
     */
    public static Stream<Arguments> provideDigestTestVectors() {
        return Stream.of(Arguments.of(ProtocolVersion.TLS10, CipherSuite.TLS_DHE_DSS_WITH_AES_128_CBC_SHA),
            ...
            Arguments.of(ProtocolVersion.TLS10, CipherSuite.TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256),
            ...
            Arguments.of(ProtocolVersion.TLS12, CipherSuite.TLS_GOSTR341001_WITH_28147_CNT_IMIT),
            Arguments.of(ProtocolVersion.TLS12, CipherSuite.TLS_GOSTR341094_WITH_NULL_GOSTR3411));
    }
    ...
    public void testDigest(ProtocolVersion providedProtocolVersion, CipherSuite providedCipherSuite) {
        digest.setRawBytes(testArray);
