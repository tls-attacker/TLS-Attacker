...
public class HelloVerifyRequestPreparatorTest
    extends AbstractTlsMessagePreparatorTest<HelloVerifyRequestMessage, HelloVerifyRequestPreparator> {

    public HelloVerifyRequestPreparatorTest() {
        super(HelloVerifyRequestMessage::new, HelloVerifyRequestMessage::new, HelloVerifyRequestPreparator::new);
    }
