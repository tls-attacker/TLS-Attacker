...
public class ClientCertificateTypeExtensionPreparatorTest
    extends AbstractExtensionMessagePreparatorTest<ClientCertificateTypeExtensionMessage,
        ClientCertificateTypeExtensionSerializer, ClientCertificateTypeExtensionPreparator> {

    public ClientCertificateTypeExtensionPreparatorTest() {
        super(ClientCertificateTypeExtensionMessage::new, ClientCertificateTypeExtensionMessage::new,
            ClientCertificateTypeExtensionSerializer::new, ClientCertificateTypeExtensionPreparator::new);
    }
    ...
    public void testPrepare() {
        ...
        assertArrayEquals(ExtensionType.CLIENT_CERTIFICATE_TYPE.getValue(), message.getExtensionType().getValue());
