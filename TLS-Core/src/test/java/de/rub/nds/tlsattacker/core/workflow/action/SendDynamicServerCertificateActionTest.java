...
public class SendDynamicServerCertificateActionTest extends AbstractActionTest<SendDynamicServerCertificateAction> {
    ...
    public void testToString() {
        ...
        assertEquals("Send Dynamic Certificate Action:\n\tMessages:CERTIFICATE, \n", action.toString());
    }

    @Test
    public void testToCompactString() {
        assertEquals("SendDynamicServerCertificateAction [server] (no messages set)", action.toCompactString());
        action.execute(state);
        assertEquals("SendDynamicServerCertificateAction [server] (CERTIFICATE)", action.toCompactString());
    }
    ...
    public void testHashCode() {
        SendDynamicServerCertificateAction compareAction1 = new SendDynamicServerCertificateAction();
        SendDynamicServerCertificateAction compareAction2 = new SendDynamicServerCertificateAction();
    ...
    public void testSendNoCertificate() {
        ...
        state.getTlsContext().setSelectedCipherSuite(CipherSuite.TLS_DH_anon_EXPORT_WITH_RC4_40_MD5);
        action.execute(state);
