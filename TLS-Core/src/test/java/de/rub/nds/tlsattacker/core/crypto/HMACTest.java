...
public class HMACTest extends TestCase {
    ...
    public void testInitSHA() throws NoSuchAlgorithmException {
        ...
        byte[] secret = ArrayConverter.hexStringToByteArray("DEADBEEFC0FEDEADBEEFC0FEDEADBEEFC0FEDEAD");
    ...
    public void testComputeMD5() throws NoSuchAlgorithmException {
        ...
        byte[] secret = ArrayConverter.hexStringToByteArray(
        ...
        hmac.init(secret, data);
        hmac.compute();
        assertArrayEquals(data, hmac.getData());
        assertArrayEquals(ArrayConverter.hexStringToByteArray("01e0addb7aead7e768509ed98cd17554"), hmac.hash(secret));
        assertArrayEquals(ArrayConverter.hexStringToByteArray("9cf299c466fbe455d0b6dfe28d27f55f"), hmac.getHmac());
    }
