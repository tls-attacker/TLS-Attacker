...
public class ServerHelloMessageSerializerTest {
    ...
    public ServerHelloMessageSerializerTest(byte[] message, byte messageType, int messageLength, byte[] protocolVersion, byte[] unixTime, byte[] random, int sessionIdLength, byte[] sessionID, byte[] selectedCiphersuite, byte selectedCompression, Integer extensionLength) {
