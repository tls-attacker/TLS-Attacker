...
public class HelloRequestHandlerTest {
    ...
    // HandshakeMessageType.HELLO_REQUEST.getValue() },
    ...
    // HelloRequestMessage message = handler.getProtocolMessage();
    //
    // assertNotNull("Confirm that parseMessage didn't return 'NULL'",
    // endPointer);
    // assertEquals("Confirm expected message type: \"HelloRequest\"",
    ...
    // + "actual number of message bytes",
