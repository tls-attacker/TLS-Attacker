...
public class SSL2ServerHelloParserTest {
    ...
    public static Collection<Object[]> generateData() {
        return Arrays.asList(new Object[][] { { ArrayConverter.hexStringToByteArray(
            ...
            ProtocolVersion.SSL2, 526, HandshakeMessageType.SERVER_HELLO, 0 /* 0x00 */, 1 /* 0x01 */,
            ProtocolVersion.SSL2.getValue(), 493 /* 0x01ed */, 6 /* 0x0006 */, 16 /* 0x0010 */,
    ...
    public SSL2ServerHelloParserTest(byte[] message, ProtocolVersion version, int messageLength,
        HandshakeMessageType type, int sessionIdHit, int certificateType, byte[] protocolVersion, int certificateLength,
        int cipherSuitesLength, int sessionIdLength, byte[] certificate, byte[] cipherSuites, byte[] sessionId) {
    ...
    public void parseTest() {
        SSL2ServerHelloParser parser = new SSL2ServerHelloParser(new ByteArrayInputStream(message), version, config);
