...
public class ClientHelloParserTest {
    ...
    public static Collection<Object[]> generateData() {
        return Arrays.asList(new Object[][] { { ArrayConverter.hexStringToByteArray(
            ...
            HandshakeMessageType.CLIENT_HELLO, 0x78, ProtocolVersion.TLS12, ProtocolVersion.TLS12.getValue(),
            ...
            { ArrayConverter.hexStringToByteArray(
                ...
                HandshakeMessageType.CLIENT_HELLO, 0x00be, ProtocolVersion.TLS11, ProtocolVersion.TLS11.getValue(),
            ...
            { ArrayConverter.hexStringToByteArray(
                ...
                HandshakeMessageType.CLIENT_HELLO, 0x00be, ProtocolVersion.TLS10, ProtocolVersion.TLS10.getValue(),
    ...
    public ClientHelloParserTest(byte[] message, HandshakeMessageType type, int length, ProtocolVersion version, byte[] protocolVersion, byte[] unixTime,
