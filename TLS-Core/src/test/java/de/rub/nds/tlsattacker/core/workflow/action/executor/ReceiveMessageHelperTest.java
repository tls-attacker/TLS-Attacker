...
public class ReceiveMessageHelperTest {
    ...
    public void testReceiveDTLSMessages() {
        MessageActionResult result =
            receive(DTLS.REC_SERVER_HELLO_F1, DTLS.REC_SERVER_HELLO_F2, DTLS.REC_SERVER_HELLO_DONE);
    ...
    public void testReceiveDTLSMessagesDisorderly() {
        MessageActionResult result =
            receive(DTLS.REC_SERVER_HELLO_F1, DTLS.REC_SERVER_HELLO_DONE, DTLS.REC_SERVER_HELLO_F2);
        assertEquals(3, result.getMessageFragmentList().size());
        assertEquals(2, result.getMessageList().size());
        checkMessage(result.getMessageList().get(0), DTLS.MSG_SERVER_HELLO_ASSEMBLED);
    ...
    public void testReceiveDTLSMessagesManyRepeats() {
        context.setSelectedProtocolVersion(ProtocolVersion.DTLS12);
        MessageActionResult result =
            receive(DTLS.REC_SERVER_HELLO_F1, DTLS.REC_SERVER_HELLO_F2, DTLS.REC_SERVER_HELLO_F1,
                DTLS.REC_SERVER_HELLO_F2, DTLS.REC_SERVER_HELLO_F1, DTLS.REC_SERVER_HELLO_F2);
    ...
    static class DTLS {
        ...
        private static final byte[] REC_SERVER_HELLO_F2 = ArrayConverter
            .hexStringToByteArray("16fefd0000000000000005001c" + "0200005b000100004b00001000ff0100010000230000000b0"
                + "0020100");
        ...
        private static final byte[] MSG_SERVER_HELLO_SINGLE_FRAGMENT =
            ArrayConverter
