...
public class NewSessionTicketParserTest {
    ...
    private static byte[] sessionTicketTls1_1 =
        ArrayConverter
    ...
    private static byte[] sessionTicketTls1_1_identity =
        ArrayConverter
    ...
    private static byte[] sessionTicketTls1_2 =
        ArrayConverter
    ...
    private static byte[] sessionTicketTls1_2_identity =
        ArrayConverter
    ...
    private static byte[] sessionTicketTls1_3 =
        ArrayConverter
    ...
    private static byte[] sessionTicketTls1_3_identity =
        ArrayConverter
