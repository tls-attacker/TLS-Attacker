...
public class CertificateHandlerTest {
    ...
    /**
     * Test of getParser method, of class CertificateHandler.
     */
    @Test
    ...
    /**
     * Test of getPreparator method, of class CertificateHandler.
     */
    @Test
    ...
    /**
     * Test of getSerializer method, of class CertificateHandler.
     */
    @Test
    ...
    /**
     * Test of adjustTLSContext method, of class CertificateHandler.
     */
    @Test
    ...
    public void testAdjustTLSContextWithUnparsableCertificate() {
        ...
        message.setCertificatesLength(5);
        handler.adjustTLSContext(message);
        assertNull(context.getClientCertificate());
        assertNull(context.getServerCertificate());
        context.setTalkingConnectionEnd(ConnectionEnd.SERVER);
