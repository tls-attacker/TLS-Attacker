...
public class TestCertificates {
    ...
    /**
     * Initialize a KeyStore from an ordinary OpenSSL RSA (cert,key) pair as generated with
     * "openssl req -x509 -newkey rsa:4096 -keyout key.pem -out cert.pem" For a less hacky version check
