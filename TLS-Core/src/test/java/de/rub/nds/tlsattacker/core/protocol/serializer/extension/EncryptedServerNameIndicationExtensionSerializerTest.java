...
public class EncryptedServerNameIndicationExtensionSerializerTest extends AbstractExtensionMessageSerializerTest<
    EncryptedServerNameIndicationExtensionMessage, EncryptedServerNameIndicationExtensionSerializer> {

    public EncryptedServerNameIndicationExtensionSerializerTest() {
        super(EncryptedServerNameIndicationExtensionMessage::new, EncryptedServerNameIndicationExtensionSerializer::new,
            List.of((msg, obj) -> msg.setEsniMessageTypeConfig((EsniMessageType) obj),
                ...
                (msg, obj) -> msg.setRecordDigestLength((Integer) obj), (msg, obj) -> msg.setRecordDigest((byte[]) obj),
