...
public class StunTurnLayerTest {
    ...
    public void setUp() throws IOException {
        ...
        LayerStack stack = new LayerStack(context, new IceLayer(context.getIceContext()),
    ...
    public void testSendConfiguration() throws IOException {
        ...
        layer.setLayerConfiguration(new SpecificSendLayerConfiguration<>(ImplementedLayers.ICE,
                message));
    ...
    public void testReceiveConfiguration() throws IOException {
        layer.setLayerConfiguration(new SpecificReceiveLayerConfiguration<StunMessage>(ImplementedLayers.ICE, new StunMessage(null, null)));
        context.setTransportHandler(new StreamTransportHandler(0, ConnectionEndType.CLIENT,
