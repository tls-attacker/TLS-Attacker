...
public class PWDServerKeyExchangeParserTest {
    ...
    public void testParse() {
        ...
        byte[] message =
            ArrayConverter.hexStringToByteArray(("0c 00 00 87 20 96 3c 77 cd c1\n"
        ...
        byte[] salt =
            ArrayConverter.hexStringToByteArray(("96 3c 77 cd c1 3a 2a 8d 75 cd dd d1 e0 44 99 29\n"
                + "             84 37 11 c2 1d 47 ce 6e 63 83 cd da 37 e4 7d a3").replaceAll("\\s+", ""));

        byte[] element =
            ArrayConverter.hexStringToByteArray(("04 22 bb d5 6b 48 1d 7f a9 0c 35 e8 d4 2f cd 06\n"
        ...
        byte[] scalar =
            ArrayConverter.hexStringToByteArray(("2f 70 48 96 69 9f c4 24 d3 ce c3 37 17 64 4f 5a\n"
