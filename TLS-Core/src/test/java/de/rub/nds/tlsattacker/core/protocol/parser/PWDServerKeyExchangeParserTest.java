...
public class PWDServerKeyExchangeParserTest
    extends AbstractHandshakeMessageParserTest<PWDServerKeyExchangeMessage, PWDServerKeyExchangeParser> {

    public PWDServerKeyExchangeParserTest() {
        super(PWDServerKeyExchangeMessage.class, PWDServerKeyExchangeParser::new,
            List.of(Named.of("PWDServerKeyExchangeMessage::getSaltLength", PWDServerKeyExchangeMessage::getSaltLength),
                Named.of("PWDServerKeyExchangeMessage::getSalt", PWDServerKeyExchangeMessage::getSalt),
                Named.of("PWDServerKeyExchangeMessage::getElementLength",
                    PWDServerKeyExchangeMessage::getElementLength),
                Named.of("PWDServerKeyExchangeMessage::getElement", PWDServerKeyExchangeMessage::getElement),
                Named.of("PWDServerKeyExchangeMessage::getScalarLength", PWDServerKeyExchangeMessage::getScalarLength),
                Named.of("PWDServerKeyExchangeMessage::getScalar", PWDServerKeyExchangeMessage::getScalar),
                Named.of("PWDServerKeyExchangeMessage::getGroupType", PWDServerKeyExchangeMessage::getGroupType),
                Named.of("PWDServerKeyExchangeMessage::getNamedGroup", PWDServerKeyExchangeMessage::getNamedGroup),
    ...
    public static Stream<Arguments> provideTestVectors() {
        return Stream.of(Arguments.of(ProtocolVersion.TLS12, ArrayConverter.hexStringToByteArray(
            ...
            Arrays.asList(HandshakeMessageType.SERVER_KEY_EXCHANGE.getValue(), 135, 32,
                ...
                32,
                ArrayConverter.hexStringToByteArray("2f704896699fc424d3cec33717644f5adf7f68483424ee51492bb96613fc4921"),
                EllipticCurveType.NAMED_CURVE.getValue(), NamedGroup.BRAINPOOLP256R1.getValue(), null, null, null, null,
                null)));
    }
}
