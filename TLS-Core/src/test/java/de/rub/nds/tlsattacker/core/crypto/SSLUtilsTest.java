...
public class SSLUtilsTest {
    ...
    @ParameterizedTest
    @EnumSource(value = MacAlgorithm.class, names = { "SSLMAC_MD5", "SSLMAC_SHA1" })
    public void testSslMac(MacAlgorithm providedMacAlgorithm) throws NoSuchAlgorithmException, InvalidKeyException {
        byte[] input = { 1, 2, 3 };
