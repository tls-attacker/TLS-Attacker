...
public class DockerHandshakeIT {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
            ...
            {true, false, CipherSuite.TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384, ProtocolVersion.TLS12,
                WorkflowTraceType.FULL_RESUMPTION},
            {true, false, CipherSuite.TLS_RSA_WITH_AES_128_GCM_SHA256, ProtocolVersion.TLS12,
                WorkflowTraceType.HANDSHAKE},
            {true, false, CipherSuite.TLS_RSA_WITH_AES_128_GCM_SHA256, ProtocolVersion.TLS12,
                WorkflowTraceType.FULL_RESUMPTION},
            {true, false, CipherSuite.TLS_RSA_WITH_AES_256_GCM_SHA384, ProtocolVersion.TLS12,
                WorkflowTraceType.HANDSHAKE},
            {true, false, CipherSuite.TLS_RSA_WITH_AES_256_GCM_SHA384, ProtocolVersion.TLS12,
                WorkflowTraceType.FULL_RESUMPTION},
            {true, false, CipherSuite.TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, ProtocolVersion.TLS12,
                WorkflowTraceType.HANDSHAKE},
            {true, false, CipherSuite.TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, ProtocolVersion.TLS12,
                WorkflowTraceType.FULL_RESUMPTION},
            {true, false, CipherSuite.TLS_DHE_RSA_WITH_AES_256_GCM_SHA384, ProtocolVersion.TLS12,
                WorkflowTraceType.HANDSHAKE},
            {true, false, CipherSuite.TLS_DHE_RSA_WITH_AES_256_GCM_SHA384, ProtocolVersion.TLS12,
                WorkflowTraceType.FULL_RESUMPTION},
            {true, false, CipherSuite.TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, ProtocolVersion.TLS12,
                WorkflowTraceType.HANDSHAKE},
            {true, false, CipherSuite.TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, ProtocolVersion.TLS12,
                WorkflowTraceType.FULL_RESUMPTION},
            {true, false, CipherSuite.TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384, ProtocolVersion.TLS12,
                WorkflowTraceType.HANDSHAKE},
            {true, false, CipherSuite.TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384, ProtocolVersion.TLS12,
                WorkflowTraceType.FULL_RESUMPTION},
    ...
    public String toString() {
        return "DockerHandshakeIT{" + "addEncryptThenMac=" + addEncryptThenMac + ", addExtendedMasterSecret=" + addExtendedMasterSecret + ", suite=" + suite + ", version=" + version + ", traceType=" + traceType + '}';
    }
