...
public class RSAClientKeyExchangePreparatorTest {
    ...
    public void testPrepare() {
    	...
    	assertArrayEquals(ArrayConverter.concatenate(ArrayConverter.hexStringToByteArray("AABBCCDDEEFF"), 
    			ArrayConverter.hexStringToByteArray("AABBCCDDEEFF")), message.getComputations().getClientRandom().getValue());
