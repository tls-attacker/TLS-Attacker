...
public class RSAClientKeyExchangeHandlerTest {
    ...
    // try {
    // ClassLoader loader =
    // RSAClientKeyExchangeHandlerTest.class.getClassLoader();
    ...
    // tlsContext.getConfig().getKeyStore().getCertificate(alias);
    // if (alias == null || sunCert == null) {
    // throw new
    // ConfigurationException("The certificate cannot be fetched. Have you provided correct "
    ...
    // ex) {
    // throw new
    // ConfigurationException("Certificate with the selected alias could not be found",
    // ex);
    // }
    ...
    // handler.setProtocolMessage(new RSAClientKeyExchangeMessage(new
    // TlsConfig()));
    //
    ...
    // assertArrayEquals("Confirm excepted Premastersecret",
    // exceptedPremastersecret, message.getPremasterSecret()
    // .getValue());
