...
public class ECDHEServerKeyExchangePreparatorTest
                ...
                .setDefaultExplicitCertificateKeyPair(
                        new CertificateKeyPair(
                                ...
                                new CustomECPrivateKey(
                                        context.getConfig().getDefaultClientEcPrivateKey(),
                                        context.getConfig().getDefaultSelectedNamedGroup())));
    ...
    private void loadTestVectorsToContext() {
        ...
        config.setDefaultServerRSAModulus(
                new BigInteger(
        ...
        config.setDefaultServerRSAPrivateKey(
                new BigInteger(
