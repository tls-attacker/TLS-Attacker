...
public class ECDHEServerKeyExchangePreparatorTest {
    ...
    public void setUp() throws Exception {
        ...
        tlsContext.getConfig().setDefaultServerEcPrivateKey(new BigInteger(
    ...
    public void testPrepareHandshakeMessageContents() throws IOException {
        ...
        tlsContext.getConfig().setDefaultExplicitCertificateKeyPair(
            new CertificateKeyPair(cert, new CustomECPrivateKey(tlsContext.getConfig().getDefaultClientEcPrivateKey(),
                tlsContext.getConfig().getDefaultSelectedNamedGroup())));
        tlsContext.getConfig().setAutoSelectCertificate(false);
        assertArrayEquals(ArrayConverter.concatenate(tlsContext.getClientRandom(), tlsContext.getServerRandom()),
        ...
        assertEquals(serializedPubKeyExpected, ArrayConverter.bytesToRawHexString(msg.getPublicKey().getValue()));
