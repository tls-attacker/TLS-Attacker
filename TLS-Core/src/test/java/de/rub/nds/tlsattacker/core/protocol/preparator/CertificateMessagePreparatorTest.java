...
public class CertificateMessagePreparatorTest {
    ...
    public void testPrepare() throws IOException {
        ...
        preparator.prepare();
        System.out.println("Certificate in config: "
                + ArrayConverter.bytesToHexString(context.getConfig().getDefaultRsaCertificate(), false, false));
        System.out.println("Certificate in msg after preparation: "
