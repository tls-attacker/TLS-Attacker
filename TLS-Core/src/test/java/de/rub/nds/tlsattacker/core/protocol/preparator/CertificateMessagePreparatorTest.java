...
public class CertificateMessagePreparatorTest {
    ...
    private static final ProtocolVersion[] PROTOCOLS =
        { ProtocolVersion.SSL3, ProtocolVersion.TLS10, ProtocolVersion.TLS11, ProtocolVersion.TLS12 };
    ...
    public void testPrepare() throws IOException {
        for (ProtocolVersion version : PROTOCOLS) {
            ...
            final CertificateMessage message = new CertificateMessage();
            ...
            assertArrayEquals(message.getCertificatesListBytes().getValue(), ArrayConverter.hexStringToByteArray(
