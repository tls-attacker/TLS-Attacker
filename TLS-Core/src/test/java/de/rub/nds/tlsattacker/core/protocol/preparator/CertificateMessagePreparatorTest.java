...
public class CertificateMessagePreparatorTest {
    ...
    public void testPrepare() throws IOException {
        for (ProtocolVersion version : PROTOCOLS) {
            ...
            final CertificateMessagePreparator preparator =
                new CertificateMessagePreparator(context.getChooser(), message);
            context.getConfig().setDefaultExplicitCertificateKeyPair(
                new CertificateKeyPair(cert, new CustomRSAPrivateKey(context.getConfig().getDefaultClientRSAModulus(),
