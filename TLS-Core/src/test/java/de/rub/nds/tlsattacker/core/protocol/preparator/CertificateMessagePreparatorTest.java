...
public class CertificateMessagePreparatorTest
    extends AbstractTlsMessagePreparatorTest<CertificateMessage, CertificateMessagePreparator> {

    private final Certificate certificate;

    public CertificateMessagePreparatorTest() throws IOException {
        super(CertificateMessage::new, CertificateMessage::new, CertificateMessagePreparator::new);
        context.setSelectedCipherSuite(CipherSuite.TLS_RSA_WITH_AES_128_CBC_SHA);
        certificate = Certificate.parse(new ByteArrayInputStream(ArrayConverter.hexStringToByteArray(
    ...
    public void testPrepare() throws IOException {
        context.getConfig()
            .setDefaultExplicitCertificateKeyPair(new CertificateKeyPair(certificate,
                new CustomRSAPrivateKey(context.getConfig().getDefaultClientRSAModulus(),
        ...
        assertEquals(HandshakeMessageType.CERTIFICATE.getValue(), (byte) message.getType().getValue());
        assertEquals(0x00039A, (int) message.getLength().getValue());
    }

    @ParameterizedTest
    @EnumSource(value = ProtocolVersion.class, names = { "SSL3", "TLS10", "TLS11", "TLS12" })
    public void testPrepareWithDifferentProtocolVersions(ProtocolVersion protocolVersion) throws IOException {
