...
public class HandlerFactoryTest {
    ...
    public void getExtensionHandler() {
        ...
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.CACHED_INFO) instanceof CachedInfoExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.CERT_TYPE) instanceof CertificateTypeExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.CLIENT_AUTHZ) instanceof ClientAuthzExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.CLIENT_CERTIFICATE_TYPE) instanceof ClientCertificateTypeExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.CLIENT_CERTIFICATE_URL) instanceof ClientCertificateUrlExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.EARLY_DATA) instanceof EarlyDataExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.EC_POINT_FORMATS) instanceof EcPointFormatExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.ELLIPTIC_CURVES) instanceof EllipticCurvesExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.ENCRYPT_THEN_MAC) instanceof EncryptThenMacExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.EXTENDED_MASTER_SECRET) instanceof ExtendedMasterSecretExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.HEARTBEAT) instanceof HeartbeatExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.KEY_SHARE_OLD) instanceof KeyShareExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.KEY_SHARE) instanceof KeyShareExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.MAX_FRAGMENT_LENGTH) instanceof MaxFragmentLengthExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.PADDING) instanceof PaddingExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.PRE_SHARED_KEY) instanceof PreSharedKeyExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.PSK_KEY_EXCHANGE_MODES) instanceof PSKKeyExchangeModesExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.RENEGOTIATION_INFO) instanceof RenegotiationInfoExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.SERVER_AUTHZ) instanceof ServerAuthzExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.SERVER_CERTIFICATE_TYPE) instanceof ServerCertificateTypeExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.SERVER_NAME_INDICATION) instanceof ServerNameIndicationExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.SESSION_TICKET) instanceof SessionTicketTlsExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.SIGNATURE_AND_HASH_ALGORITHMS) instanceof SignatureAndHashAlgorithmsExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.SIGNED_CERTIFICATE_TIMESTAMP) instanceof SignedCertificateTimestampExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.SRP) instanceof SrpExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.STATUS_REQUEST) instanceof CertificateStatusRequestExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.STATUS_REQUEST_V2) instanceof CertificateStatusRequestV2ExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.SUPPORTED_VERSIONS) instanceof SupportedVersionsExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.TOKEN_BINDING) instanceof TokenBindingExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.TRUNCATED_HMAC) instanceof TruncatedHmacExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.TRUSTED_CA_KEYS) instanceof TrustedCaIndicationExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.UNKNOWN) instanceof UnknownExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.USER_MAPPING) instanceof UserMappingExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.USE_SRTP) instanceof SrtpExtensionHandler);
        assertTrue(HandlerFactory.getExtensionHandler(context, ExtensionType.PWD_PROTECT) instanceof PWDProtectExtensionHandler);
