...
public class PWDServerKeyExchangeSerializerTest
    extends AbstractHandshakeMessageSerializerTest<PWDServerKeyExchangeMessage, PWDServerKeyExchangeSerializer> {

    public PWDServerKeyExchangeSerializerTest() {
        super(PWDServerKeyExchangeMessage::new, PWDServerKeyExchangeSerializer::new,
            List.of((msg, obj) -> msg.setSaltLength((Integer) obj), (msg, obj) -> msg.setSalt((byte[]) obj),
                (msg, obj) -> msg.setElementLength((Integer) obj), (msg, obj) -> msg.setElement((byte[]) obj),
                (msg, obj) -> msg.setScalarLength((Integer) obj), (msg, obj) -> msg.setScalar((byte[]) obj),
                (msg, obj) -> msg.setCurveType((Byte) obj), (msg, obj) -> msg.setNamedGroup((byte[]) obj)));
    }
