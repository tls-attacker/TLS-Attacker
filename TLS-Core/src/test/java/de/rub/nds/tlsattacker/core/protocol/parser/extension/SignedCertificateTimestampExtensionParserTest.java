...
public class SignedCertificateTimestampExtensionParserTest extends
    AbstractExtensionParserTest<SignedCertificateTimestampExtensionMessage, SignedCertificateTimestampExtensionParser> {

    public SignedCertificateTimestampExtensionParserTest() {
        super(SignedCertificateTimestampExtensionMessage.class, SignedCertificateTimestampExtensionParser::new,
            List.of(Named.of("SignedCertificateTimestampExtensionMessage::getSignedTimestamp",
                SignedCertificateTimestampExtensionMessage::getSignedTimestamp)));
    }

    public static Stream<Arguments> provideTestVectors() {
        return Stream
            .of(Arguments.of(ArrayConverter.hexStringToByteArray("00120000"), List.of(),
                ExtensionType.SIGNED_CERTIFICATE_TIMESTAMP, 0, List.of(new byte[0])),
                Arguments.of(
                    ...
                    List.of(), ExtensionType.SIGNED_CERTIFICATE_TIMESTAMP, 241,
                    List.of(ArrayConverter.hexStringToByteArray("00ef007500ee4bbdb775ce60"
                        + "bae142691fabe19e66a30f7e5fb072d8" + "8300c47b897aa8fdcb0000015b8fdb11"
                        + "14000004030046304402210089716b43" + "ce66822358196424ebae1182ead83b7c"
                        + "126c664528ce222aa2b6e54d021f2377" + "d1be9703495ed3ea3c3e60438381fa08"
                        + "e07713b168ff86091bfec8876d007600" + "ddeb1d2b7a0d4fa6208b81ad8168707e"
