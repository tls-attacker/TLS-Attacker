...
public class FinishedHandlerTest {
    ...
    // assertTrue(finishedMessage.getHandshakeMessageType() ==
    // HandshakeMessageType.FINISHED);
    // assertTrue(finishedMessage.getProtocolMessageType() ==
    ...
    // finishedHandler.setProtocolMessage(finishedMessage);
    // finishedHandler.parseMessageAction(ArrayConverter.hexStringToByteArray("1300000CC50EA95C9DFEBEBACF12C353"),
    // 0);
    //
    // }
    //
    ...
    // finishedHandler.parseMessage(ArrayConverter.hexStringToByteArray("1400000CA33B9CC92745BCF6C796AF7F"),
    // 0);
    // }
    //
    ...
    // finishedHandler.setProtocolMessage(finishedMessage);
    // finishedHandler.parseMessageAction(ArrayConverter.hexStringToByteArray("1400000CA33B9CC92745BCF6C796AF7F"),
    // 0);
    // assertArrayEquals(finishedMessage.getVerifyData().getOriginalValue(),
    // ArrayConverter.hexStringToByteArray("A33B9CC92745BCF6C796AF7F"));
    // assertArrayEquals(finishedMessage.getCompleteResultingMessage().getOriginalValue(),
    ...
    // finishedHandler.setProtocolMessage(finishedMessage);
    // finishedHandler.parseMessageAction(ArrayConverter.hexStringToByteArray("1400000CC50EA95C9DFEBEBACF12C353"),
    // 0);
    // assertArrayEquals(finishedMessage.getVerifyData().getOriginalValue(),
    // ArrayConverter.hexStringToByteArray("C50EA95C9DFEBEBACF12C353"));
    // assertArrayEquals(finishedMessage.getCompleteResultingMessage().getOriginalValue(),
    ...
    // ArrayConverter.hexStringToByteArray("00000000000000001400000CC50EA95C9DFEBEBACF12C353"),
    // 8);
    // assertArrayEquals(finishedMessage.getVerifyData().getOriginalValue(),
    // ArrayConverter.hexStringToByteArray("C50EA95C9DFEBEBACF12C353"));
    // assertArrayEquals(finishedMessage.getCompleteResultingMessage().getOriginalValue(),
