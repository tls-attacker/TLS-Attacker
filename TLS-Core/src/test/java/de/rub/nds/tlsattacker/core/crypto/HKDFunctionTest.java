...
public class HKDFunctionTest {
    ...
    public void testExtractAndExpand() throws CryptoException {
        ...
        byte[] ikm =
                ArrayConverter.hexStringToByteArray("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b");
    ...
    public void testExpand() throws CryptoException {
        byte[] expand =
                HKDFunction.expand(
                        ...
                        ArrayConverter.hexStringToByteArray("001009746c733133206b657900"),
                        16);
        assertArrayEquals(
                ArrayConverter.hexStringToByteArray("c66cb1aec519df44c91e10995511ac8b"), expand);
    }
}
