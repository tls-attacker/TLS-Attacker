...
public class MacWrapperTest {
    ...
    public void testGOST3411() throws NoSuchAlgorithmException {
        ...
        byte[] actual = mac.calculateMac("Test data".getBytes());
        byte[] expected = ArrayConverter.hexStringToByteArray("9E1A18525244994DF9D9006D057B4CA01093458D40DA788A91E6324278E575DF");
        assertArrayEquals(expected, actual);

        actual = mac.calculateMac(" extended".getBytes());
        expected = ArrayConverter.hexStringToByteArray("C0ECFFEA5D7021D84C74227D7A7E80C2C6BD5F3C5F298E904AF9A4BA5C5E5AEF");
        assertArrayEquals(expected, actual);
    }
