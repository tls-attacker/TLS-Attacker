...
public class PWDServerKeyExchangePreparatorTest
    extends AbstractTlsMessagePreparatorTest<PWDServerKeyExchangeMessage, PWDServerKeyExchangePreparator> {
    ...
    public PWDServerKeyExchangePreparatorTest() {
        super(PWDServerKeyExchangeMessage::new, PWDServerKeyExchangeMessage::new, PWDServerKeyExchangePreparator::new);
    ...
    public void testPrepare() {
        ...
        assertArrayEquals(NamedGroup.BRAINPOOLP256R1.getValue(), message.getNamedGroup().getValue());
