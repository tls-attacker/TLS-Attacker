...
public class RecordStreamCipherTest {
    ...
    public RecordStreamCipherTest() {
        keySet = generateKeySet(
                ...
                new byte[1], ArrayConverter.hexStringToByteArray("DEADBEEFC0FEDEADBEEFC0FEDEADBEEFC0FEDEAD"));
    ...
    private KeySet generateKeySet(byte[] clientWriteKey, byte[] clientWriteMacSecret, byte[] serverWriteKey, byte[] serverWriteMacSecret){
    ...
    private TlsContext setContext(AliasedConnection connection, CipherSuite cipherSuite, ProtocolVersion protocolVersion){
    ...
    public void calculateMacSHA(){
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.TLS10);
    ...
    public void calculateMacMD5(){
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.TLS10);
    ...
    public void testEncryptSSL2SHA() throws CryptoException{
         ...
         */
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.SSL2);
    ...
    public void testDecryptSSL2SHA() throws CryptoException{
         ...
         * SSL2! Those tests are for test purposes only to check if the undefined behavior is working.
         */
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.SSL2);
    ...
    public void testEncryptSSL2MD5() throws CryptoException{
         ...
         * SSL2! Those tests are for test purposes only to check if the undefined behavior is working.
         */
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.SSL2);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.SSL2);
        RecordStreamCipher cipher = new RecordStreamCipher(context, keySet);
        cipher.encrypt(record);
    ...
    public void testDecryptSSL2MD5() throws CryptoException {
        ...
        byte[] data =
                ArrayConverter.hexStringToByteArray("805264444f48ea5b98a0ceb3884c2ef7a66207d4305ec2ab84854d93aa9dffd2");
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.SSL2);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.SSL2);
        RecordStreamCipher plaintext = new RecordStreamCipher(context, keySet);
        plaintext.decrypt(record);
    ...
    public void testEncryptSSL3SHA() throws CryptoException{
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.SSL3);
    ...
    public void testDecryptSSL3SHA() throws CryptoException{
        ...
        byte[] data2 = ArrayConverter
                .hexStringToByteArray("265c875f34c97ea7a57406296e9c1fa0be5fbcbd97d3e897d1a43e229f84c0f28bd49338");
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.SSL3);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.SSL3);
        RecordStreamCipher plaintext = new RecordStreamCipher(context, keySet);
        plaintext.decrypt(record);
    ...
    public void testEncryptSSL3MD5() throws CryptoException{
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.SSL3);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.SSL3);
        RecordStreamCipher cipher = new RecordStreamCipher(context, keySet);
        cipher.encrypt(record);
    ...
    public void testDecryptSSL3MD5() throws CryptoException{
        ...
        byte[] data2 =
                ArrayConverter.hexStringToByteArray("4492241d265c875f34c97ea7a5740629a900fe91adb02a8f27815589c0384db4");
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.SSL3);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.SSL3);
        RecordStreamCipher plaintext = new RecordStreamCipher(context, keySet);
        plaintext.decrypt(record);
    ...
    public void testDecryptTLSv10SHA() throws CryptoException{
        ...
        byte[] data2 = ArrayConverter
                .hexStringToByteArray("265c875f34c97ea7a57406296e9c1fa0965267f4480ae834e8d6038f660e5557c64ec0f8");
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.TLS10);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.TLS10);
        RecordStreamCipher plaintext = new RecordStreamCipher(context, keySet);
        plaintext.decrypt(record);
    ...
    public void testDecryptTLSv10MD5() throws CryptoException{
        ...
        byte[] data2 =
                ArrayConverter.hexStringToByteArray("4492241d265c875f34c97ea7a5740629cee1d3d74f0a47cd6e8161d0c54bee3d");
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.TLS10);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.TLS10);
        RecordStreamCipher plaintext = new RecordStreamCipher(context, keySet);
        plaintext.decrypt(record);
    ...
    public void testEncryptTLS11SHA() throws CryptoException{
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.TLS11);
    ...
    public void testDecryptTLS11SHA() throws CryptoException{
        ...
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.TLS11);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.TLS11);
        RecordStreamCipher plaintext = new RecordStreamCipher(context, keySet);
        plaintext.decrypt(record);
    ...
    public void testEncryptTLSv11MD5() throws CryptoException{
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.TLS11);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.TLS11);
        RecordStreamCipher cipher = new RecordStreamCipher(context, keySet);
        cipher.encrypt(record);
    ...
    public void testDecryptTLSv11MD5() throws CryptoException{
        ...
        byte[] data2 =
                ArrayConverter.hexStringToByteArray("4492241d265c875f34c97ea7a5740629bafbfaf30b89e857be131c1a0ff5e933");
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.TLS11);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.TLS11);
        RecordStreamCipher plaintext = new RecordStreamCipher(context, keySet);
        plaintext.decrypt(record);
    ...
    public void testEncryptTLS12SHA() throws CryptoException{
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.TLS12);
    ...
    public void testDecryptTLS12SHA() throws CryptoException {
        ...
        byte[] data2 = ArrayConverter
                .hexStringToByteArray("265c875f34c97ea7a57406296e9c1fa06a691b117949351ea9a3d91b0772f72f457454ff");
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.TLS12);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.TLS12);
        RecordStreamCipher plaintext = new RecordStreamCipher(context, keySet);
        plaintext.decrypt(record);
    ...
    public void testEncryptTLSv12MD5() throws CryptoException{
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.TLS12);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.TLS12);
        RecordStreamCipher cipher = new RecordStreamCipher(context, keySet);
        cipher.encrypt(record);
    ...
    public void testDecryptTLSv12MD5() throws CryptoException {
        ...
        byte[] data2 =
                ArrayConverter.hexStringToByteArray("4492241d265c875f34c97ea7a5740629337b7f945d095e2cd7df551b5a75c216");
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.TLS12);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.TLS12);
        RecordStreamCipher plaintext = new RecordStreamCipher(context, keySet);
        plaintext.decrypt(record);
    ...
    public void testEncryptTLS13SHA() throws CryptoException{
        ...
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.TLS13);
    ...
    public void testDecryptTLS13SHA() throws CryptoException{
        ...
        byte[] data = ArrayConverter
                .hexStringToByteArray("805264444f48ea5b98a0ceb3884c2ef731db362d9dec4802a6b3900993dc756e99f935fe");
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_SHA, ProtocolVersion.TLS13);
        RecordStreamCipher plaintext = new RecordStreamCipher(context, keySet);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.TLS13);
        record.setLength(36);
        plaintext.decrypt(record);
    ...
    public void testEncryptTLSv13MD5() throws CryptoException{
        ...
        TlsContext context = setContext(new OutboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.TLS13);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.TLS13);
        RecordStreamCipher cipher = new RecordStreamCipher(context, keySet);
        cipher.encrypt(record);
    ...
    public void testDecryptTLSv13MD5() throws CryptoException{
        ...
        TlsContext context = setContext(new InboundConnection(), CipherSuite.TLS_RSA_WITH_RC4_128_MD5, ProtocolVersion.TLS13);
        RecordStreamCipher plaintext = new RecordStreamCipher(context, keySet);
        Record record = setRecord(new BigInteger("0"), data, ProtocolVersion.TLS13);
        record.setLength(32);
        plaintext.decrypt(record);
