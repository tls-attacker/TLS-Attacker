...
public class FinishedMessageParserTest {
    ...
    private static final byte[] MSG_0_VERIFIED_DATA = new byte[] { 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,
            0x66, 0x55, 0x44, 0x33 };
    ...
    public static Collection<Object[]> generateData() {
        return Arrays.asList(new Object[][] {
                { MSG_0, 0, MSG_0, HandshakeMessageType.FINISHED, 12, MSG_0_VERIFIED_DATA },
                { MSG_1, 6, MSG_0, HandshakeMessageType.FINISHED, 12, MSG_0_VERIFIED_DATA } });
    }
