...
public class TightReceiveActionTest {
    ...
    public void testExecute() throws Exception {
        ((FakeTransportHandler) tlsContext.getTransportHandler()).setFetchableByte(
            new byte[] { 0x15, 0x03, 0x03, 0x00, 0x02, 0x02, 50, 0x15, 0x03, 0x03, 0x00, 0x02, 0x02, 50 });
        action.execute(state);
        assertTrue(action.executedAsPlanned());
        assertEquals(action.getReceivedMessages().size(), 1);
