...
public class TightReceiveActionTest {
    ...
    /**
     * Test of execute method of class TightReceiveAction with multiple messages in separate records.
     *
     * @throws java.lang.Exception
     */
    @Test
    ...
    public void testJAXB() {
        ...
        TlsAction action2 = JAXB.unmarshal(new StringReader(writer.getBuffer().toString()), TightReceiveAction.class);
        action.normalize();
        action2.normalize();
