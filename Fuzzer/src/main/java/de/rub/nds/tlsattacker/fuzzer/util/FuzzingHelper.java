...
public class FuzzingHelper {
    ...
    public static void executeRandomModifiableVariableModification(WorkflowTrace workflow, ConnectionEnd connectionEnd,
        ...
        while (f == null) {
            holder = getRandomModifiableVariableHolder(workflow, connectionEnd);
            Field randomField = holder.getRandomModifiableVariableField();
            if(isModifiableVariableModificationAllowed(randomField, allowedTypes, allowedFormats, whitelistRegex, blacklistRegex)) {
                f = randomField;
            }
        }
    ...
    public static boolean isModifiableVariableModificationAllowed(Field randomField, List<ModifiableVariableProperty.Type> allowedTypes, List<ModifiableVariableProperty.Format> allowedFormats, String whitelistRegex, String blacklistRegex) {
