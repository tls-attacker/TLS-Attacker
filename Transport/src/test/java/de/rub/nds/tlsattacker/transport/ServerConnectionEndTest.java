...
public class ServerConnectionEndTest {

    private static final Logger LOGGER = LogManager.getLogger(ServerConnectionEndTest.class);

    @XmlRootElement
    @XmlAccessorType(XmlAccessType.FIELD)
    private static class TestXmlRoot extends ServerConnectionEnd {
    }
    ...
    /**
     * Verify that the ServerConnectionEnd can be marshaled and un-marshaled
     * properly.
     * 
     * @throws Exception
     */
    ...
    /**
     * Verify that the ServerConnectionEnd does not include unset fields in
     * serialization.
     * 
     * @throws Exception
     */
    ...
    public void testSerializeDefaultFields() throws Exception {
        ...
        ServerConnectionEndTest.TestXmlRoot expected = new ServerConnectionEndTest.TestXmlRoot();
        ...
        Unmarshaller um = context.createUnmarshaller();
        ServerConnectionEndTest.TestXmlRoot actual = (ServerConnectionEndTest.TestXmlRoot) um
